...
var routes = [
    {
        path: 'account',
        loadChildren: function () { return __webpack_require__.e(/*! import() | account-account-module */ "account-account-module").then(__webpack_require__.bind(null, /*! ./account/account.module */ "./src/app/account/account.module.ts")).then(function (m) { return m.AccountModule; }); }
    },
    {
        path: '',
...
var CustomerService = /** @class */ (function () {
    ...
    CustomerService.prototype.loadCustomer = function (filter) {
        var params = Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_3__["mapToHttpParamsQuery"])(filter);
        return this.httpClient.get(router.get_all_page, params);
    };
    CustomerService.prototype.loadCustomerById = function (filter) {
        var params = Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_3__["mapToHttpParamsQuery"])(filter);
    ...
    CustomerService.prototype.loadSourceFilter = function () {
        return this.httpClient.get(router.source);
    };
    CustomerService.prototype.loadTypeFilter = function () {
        return this.httpClient.get(router.type);
    };
    CustomerService.prototype.loadGroupFilter = function () {
...
var DepartmentService = /** @class */ (function () {
    ...
    DepartmentService.prototype.loadAllDepartment = function () {
        return this.httpClient.get(router.get_all);
    };
    DepartmentService.prototype.loadDepartmentPaged = function (filter) {
        var params = Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_3__["mapToHttpParamsQuery"])(filter);
        return this.httpClient.get(router.get_all_page, params);
    };
    ...
    DepartmentService.prototype.updateDepartment = function (filter, data) {
        var params = Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_3__["mapToHttpParamsQuery"])(filter);
        return this.httpClient.put(router.update, data, params);
    };
    DepartmentService.prototype.removeDepartment = function (departmentId) {
        var uri = Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_3__["fmt"])(router.update, { departmentId: departmentId });
...
var PositionService = /** @class */ (function () {
    ...
    PositionService.prototype.loadAllPosition = function () {
        return this.httpClient.get(router.get_all);
    };
    PositionService.prototype.loadPositionPaged = function (filter) {
        var params = Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_3__["mapToHttpParamsQuery"])(filter);
        return this.httpClient.get(router.get_all_page, params);
    };
    ...
    PositionService.prototype.updatePosition = function (filter, data) {
        var params = Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_3__["mapToHttpParamsQuery"])(filter);
        return this.httpClient.put(router.update, data, params);
    };
    PositionService.prototype.removePosition = function (positionId) {
        var uri = Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_3__["fmt"])(router.update, { positionId: positionId });
        return this.httpClient.delete(uri);
    };
...
var ProductService = /** @class */ (function () {
    ...
    ProductService.prototype.loadProduct = function (filter) {
        var params = Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_3__["mapToHttpParamsQuery"])(filter);
        return this.httpClient.get(router.get_all_page, params);
    };
    ProductService.prototype.loadProductById = function (filter) {
        var params = Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_3__["mapToHttpParamsQuery"])(filter);
        return this.httpClient.get(router.get_by_id, params);
    };
...
var ServiceService = /** @class */ (function () {
    ...
    ServiceService.prototype.loadAllService = function () {
        return this.httpClient.get(router.get_all);
    };
    ServiceService.prototype.loadServicePaged = function (filter) {
        var params = Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_3__["mapToHttpParamsQuery"])(filter);
        return this.httpClient.get(router.get_all_page, params);
    };
    ...
    ServiceService.prototype.updateService = function (filter, data) {
        var params = Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_3__["mapToHttpParamsQuery"])(filter);
        return this.httpClient.put(router.update, data, params);
    };
    ServiceService.prototype.removeService = function (serviceId) {
        var uri = Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_3__["fmt"])(router.update, { serviceId: serviceId });
        return this.httpClient.delete(uri);
    };
...
var StatisticService = /** @class */ (function () {
    ...
    StatisticService.prototype.loadRevenue = function (filter) {
        var params = Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_3__["mapToHttpParamsQuery"])(filter);
...
var TransactionService = /** @class */ (function () {
    ...
    TransactionService.prototype.loadTransaction = function (filter) {
        var params = Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_3__["mapToHttpParamsQuery"])(filter);
        return this.httpClient.get(router.search, params);
    };
