...
let ListEmailModalComponent = class ListEmailModalComponent {
    constructor() {
        this.passEvent = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.customerData = [
            {
...
let EmailCampaignComponent = class EmailCampaignComponent {
    ...
    openEmailModal() {
        const modalRef = this.modalService.open(_component_list_email_modal_list_email_modal_component__WEBPACK_IMPORTED_MODULE_4__["ListEmailModalComponent"], {
            centered: true,
            size: 'xl'
        });
        modalRef.componentInstance.passEvent.subscribe(res => {
...
EmailCampaignComponent.ctorParameters = () => [
...
let EmailTemplateModalComponent = class EmailTemplateModalComponent {
    constructor() {
        this.passEvent = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    ngOnInit() { }
...
let SmsCampaignComponent = class SmsCampaignComponent {
...
let ViewSmsTemplateModalComponent = class ViewSmsTemplateModalComponent {
    constructor() {
        this.passEvent = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    ngOnInit() { }
...
let SmsTemplateComponent = class SmsTemplateComponent {
    constructor(modalService, smsService) {
        this.modalService = modalService;
        this.smsService = smsService;
        this.destroyed$ = new rxjs__WEBPACK_IMPORTED_MODULE_7__["Subject"]();
    ...
    openTemplateModal(template) {
        const modalRef = this.modalService.open(_component_sms_template_modal_sms_template_modal_component__WEBPACK_IMPORTED_MODULE_3__["SmsTemplateModalComponent"], {
            centered: true,
            size: 'lg'
        });
        if (template) {
...
SmsTemplateComponent.ctorParameters = () => [
    { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbModal"] },
    { type: _core_services_api_sms_service__WEBPACK_IMPORTED_MODULE_5__["SmsService"] }
];
...
//# sourceMappingURL=marketing-marketing-module-es2015.js.map