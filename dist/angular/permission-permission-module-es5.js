...
var ListCompanyDetailComponent = /** @class */ (function () {
    ...
    ListCompanyDetailComponent.prototype.onChangeDuration = function () {
        this._updatePrice();
    };
    ListCompanyDetailComponent.prototype.onChangeDiscount = function () {
        this._updatePrice();
    };
    //#region Private
    ...
    ListCompanyDetailComponent.prototype._updatePrice = function () {
        var p = 0;
        this.listFunction.forEach(function (e) {
            p += e.fun_price;
        });
        var _a = this.formCompany.value, co_discount = _a.co_discount, co_duration = _a.co_duration;
        this.formCompany.patchValue({
...
var ListPackageDetailComponent = /** @class */ (function () {
    ...
    ListPackageDetailComponent.prototype._reCalPrice = function () {
        var sum = 0;
        this.listFunction.forEach(function (item) {
