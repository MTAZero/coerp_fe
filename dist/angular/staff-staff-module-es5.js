...
var AssignWorkComponent = /** @class */ (function () {
    function AssignWorkComponent(staffService, customerService, customerGroupService) {
    ...
    AssignWorkComponent.prototype._fetchFilter = function () {
        ...
        staff$.subscribe(function (res) {
            ...
            if (res.Data) {
                _this.staffSearch = res.Data[0].sta_id;
                _this._fetchData();
            }
        });
...
var BankModalComponent = /** @class */ (function () {
    ...
    BankModalComponent.prototype._loadCategory = function () {
        var _this = this;
        var category$ = this.staffService.loadBankCategory().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.destroyed$));
