...
var OrderModalComponent = /** @class */ (function () {
    ...
    OrderModalComponent.prototype._fetchFilter = function () {
        var _this = this;
        var sources$ = this.customerService.loadSourceFilter().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.destroyed$));
        sources$.subscribe(function (res) {
            _this.sources = res.Data;
        });
        var group$ = this.customerService.loadGroupFilter().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.destroyed$));
        group$.subscribe(function (res) {
            _this.groups = res.Data;
        });
        var type$ = this.customerService.loadTypeFilter().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.destroyed$));
        ...
        var staff$ = this.staffService.searchStaff(this.filterStaff).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.destroyed$));
...
var ListOrderComponent = /** @class */ (function () {
    function ListOrderComponent(modalService, formBuilder, orderService) {
    ...
    ListOrderComponent.prototype.openOrderModal = function (order, isView) {
        var _this = this;
        if (isView === void 0) { isView = false; }
        var modalRef = this.modalService.open(_component_order_modal_order_modal_component__WEBPACK_IMPORTED_MODULE_4__["OrderModalComponent"], {
            centered: true,
            size: 'xl'
        });
        if (order) {
        ...
        modalRef.componentInstance.passEvent.subscribe(function (res) {
            if (res.event) {
                if (order) {
                    _this._updateOrder(res.data);
                }
                else {
                    _this._createOrder(res.data);
                }
            }
            modalRef.close();
        });
    ...
    ListOrderComponent.prototype._fetchData = function () {
        var _this = this;
    ...
    ListOrderComponent.prototype._fetchFilter = function () {
        var _this = this;
        var paymentMethod$ = this.orderService.loadPaymentMethod().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.destroyed$));
        paymentMethod$.subscribe(function (res) {
            _this.paymentMethods = res.Data;
        });
        var orderStatus$ = this.orderService.loadOrderStatus().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.destroyed$));
        orderStatus$.subscribe(function (res) {
            _this.orderStatus = res.Data;
        });
    };
    ListOrderComponent.prototype._createOrder = function (data) {
        var _this = this;
    ...
    ListOrderComponent.prototype._updateOrder = function (updated) {
        var _this = this;
...
var ListProductTypeModalComponent = /** @class */ (function () {
    ...
    ListProductTypeModalComponent.prototype.openProductTypeModal = function () {
        var _this = this;
        var modalRef = this.modalService.open(_product_type_modal_product_type_modal_component__WEBPACK_IMPORTED_MODULE_4__["ProductTypeModalComponent"], {
            centered: true
        });
    ...
    ListProductTypeModalComponent.prototype.openConfirmModal = function () {
        var _this = this;
        var modalRef = this.modalService.open(_confirm_modal_confirm_modal_component__WEBPACK_IMPORTED_MODULE_5__["ConfirmModalComponent"], {
            centered: true
        });
        ...
        modalRef.componentInstance.passEvent.subscribe(function (res) {
            if (res) {
                _this.removeProductType(_this.selectedProductType);
            }
            modalRef.close();
        });
    };
...
var ListUnitModalComponent = /** @class */ (function () {
    ...
    ListUnitModalComponent.prototype.openUnitModal = function () {
        var _this = this;
        var modalRef = this.modalService.open(_unit_modal_unit_modal_component__WEBPACK_IMPORTED_MODULE_4__["UnitModalComponent"], {
            centered: true
        });
    ...
    ListUnitModalComponent.prototype.openConfirmModal = function () {
        ...
        modalRef.componentInstance.passEvent.subscribe(function (res) {
            if (res) {
                _this.removeUnit(_this.selectedUnit);
            }
            modalRef.close();
        });
    };
...
var ProductTypeModalComponent = /** @class */ (function () {
    function ProductTypeModalComponent(formBuilder, modalService) {
        this.formBuilder = formBuilder;
        this.modalService = modalService;
        this.passEvent = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.submitted = false;
...
var UnitModalComponent = /** @class */ (function () {
    function UnitModalComponent(formBuilder, modalService) {
        this.formBuilder = formBuilder;
        this.modalService = modalService;
        this.passEvent = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.submitted = false;
...
var ListProductComponent = /** @class */ (function () {
    function ListProductComponent(modalService, formBuilder, productService) {
        this.modalService = modalService;
        this.formBuilder = formBuilder;
        this.productService = productService;
        this.destroyed$ = new rxjs__WEBPACK_IMPORTED_MODULE_7__["Subject"]();
    ...
    ListProductComponent.prototype.openProductModal = function (product) {
        var _this = this;
        var modalRef = this.modalService.open(_component_product_modal_product_modal_component__WEBPACK_IMPORTED_MODULE_4__["ProductModalComponent"], {
            centered: true,
            size: 'lg'
        });
        if (product) {
        ...
        modalRef.componentInstance.passEvent.subscribe(function (res) {
            if (res.event) {
                if (product) {
                    _this._updateProduct(res.form);
                }
                else {
                    _this._createProduct(res.form);
                }
            }
            modalRef.close();
        });
    ...
    ListProductComponent.prototype._fetchData = function () {
        var _this = this;
        var product$ = this.productService
            .loadProduct({
            pageNumber: this.page,
    ...
    ListProductComponent.prototype._fetchFilter = function () {
        var _this = this;
        var category$ = this.productService.loadCategory().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["takeUntil"])(this.destroyed$));
        category$.subscribe(function (res) {
            _this.categories = res.Data;
        });
    };
    ListProductComponent.prototype._createProduct = function (data) {
        var _this = this;
        var createProduct$ = this.productService.createProduct(data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["takeUntil"])(this.destroyed$));
    ...
    ListProductComponent.prototype._updateProduct = function (updated) {
        var _this = this;
...
var ProductStatisticComponent = /** @class */ (function () {
    function ProductStatisticComponent(element, formBuilder, productService) {
    ...
    ProductStatisticComponent.prototype.onResize = function (e) {
        var el = this.element.nativeElement;
        this.containerHeight = el.children[0].clientHeight;
    };
    ...
    ProductStatisticComponent.prototype._fetchFilter = function () {
        var _this = this;
        var category$ = this.productService.loadCategory().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.destroyed$));
        category$.subscribe(function (res) {
            _this.categories = res.Data;
        });
    };
