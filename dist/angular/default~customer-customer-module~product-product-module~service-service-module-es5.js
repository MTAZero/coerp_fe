...
module.exports = ":host .card-body {\n  padding: 0;\n}\n:host .main {\n  padding: 10px;\n  padding-top: 20px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var CustomerGroupDetailComponent = /** @class */ (function () {
    function CustomerGroupDetailComponent(route, router, formBuilder, cgService) {
        this.route = route;
        this.router = router;
    ...
    CustomerGroupDetailComponent.prototype.ngOnInit = function () {
        this.cg_id = this.route.snapshot.paramMap.get('cg_id');
        this._initializeForm();
        if (this.cg_id)
            this._fetchCustomerGroup(this.cg_id);
    };
    CustomerGroupDetailComponent.prototype.ngOnDestroy = function () {
        this.destroyed$.next();
        this.destroyed$.complete();
    };
    CustomerGroupDetailComponent.prototype.onChangeToMain = function () {
        var _this = this;
        if (this.form.dirty) {
            sweetalert2__WEBPACK_IMPORTED_MODULE_7___default.a.fire({
                ...
                if (result.value) {
                    _this.router.navigate(['/customer/customer-group']);
                }
            });
        }
        else {
    ...
    CustomerGroupDetailComponent.prototype.onSubmit = function () {
        this.submitted = true;
        ...
        if (this.cg_id)
            this._updateService(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, data, { cg_id: this.cg_id }));
        else
            this._createService(data);
    };
    //#region Private
    CustomerGroupDetailComponent.prototype._initializeForm = function () {
    ...
    CustomerGroupDetailComponent.prototype._fetchCustomerGroup = function (cg_id) {
        var _this = this;
        var info$ = this.cgService.loadCustomerGroupInfo({ cg_id: cg_id }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.destroyed$));
        info$.subscribe(function (res) {
            if (res && res.Data) {
                _this._patchService(res.Data);
            }
        });
    };
    CustomerGroupDetailComponent.prototype._patchService = function (service) {
        this.form.patchValue({
            cg_name: service.cg_name,
            cg_description: service.cg_description,
        });
    };
    CustomerGroupDetailComponent.prototype._createService = function (data) {
        var _this = this;
        var createService$ = this.cgService
            .createCustomerGroup(data)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.destroyed$));
        createService$.subscribe(function (res) {
            if (res && res.Code === 200) {
    ...
    CustomerGroupDetailComponent.prototype._updateService = function (updated) {
        var _this = this;
        var updateService$ = this.cgService
            .updateCustomerGroup(updated)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.destroyed$));
        updateService$.subscribe(function (res) {
            if (res && res.Code === 200) {
                _this._notify(true, res.Message);
                _this.router.navigate(['/customer/customer-group']);
            }
    ...
    CustomerGroupDetailComponent.prototype._notify = function (isSuccess, message) {
    ...
    CustomerGroupDetailComponent.ctorParameters = function () { return [
    ...
    return CustomerGroupDetailComponent;
}());
...
module.exports = ":host span {\n  color: red;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var CustomerGroupModalComponent = /** @class */ (function () {
    function CustomerGroupModalComponent(formBuilder) {
        this.formBuilder = formBuilder;
    ...
    CustomerGroupModalComponent.prototype.readURL = function (event) {
        var _this = this;
        if (event.target.files && event.target.files[0]) {
            ...
            reader_1.onload = function (e) { return (_this.thumbnail = reader_1.result); };
...
module.exports = ":host .row {\n  margin-right: 0;\n}\n:host .table-responsive {\n  overflow: auto;\n  max-height: calc(100vh - 200px);\n}\n:host .table {\n  border-collapse: separate;\n  border-spacing: 0;\n}\n:host .table thead th {\n  position: -webkit-sticky;\n  position: sticky;\n  top: 0;\n  z-index: 2;\n  background-color: white;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var ListCustomerModalComponent = /** @class */ (function () {
    function ListCustomerModalComponent(customerService) {
    ...
    ListCustomerModalComponent.prototype._fetchData = function () {
        var _this = this;
    ...
    ListCustomerModalComponent.prototype._convertDateToNgbDate = function (date) {
        if (!date) {
            return null;
        }
        var year = moment__WEBPACK_IMPORTED_MODULE_5__(date).year();
        var month = moment__WEBPACK_IMPORTED_MODULE_5__(date).month() + 1;
        var day = moment__WEBPACK_IMPORTED_MODULE_5__(date).date();
        return new _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_6__["NgbDate"](year, month, day);
    };
    ListCustomerModalComponent.ctorParameters = function () { return [
...
var CustomerGroupComponent = /** @class */ (function () {
    function CustomerGroupComponent(modalService, customerGroupService, router) {
    ...
    CustomerGroupComponent.prototype.ngOnDestroy = function () {
        this.destroyed$.next();
        this.destroyed$.complete();
    };
    CustomerGroupComponent.prototype.onRouteDetail = function (group) {
        this.router.navigate(['/customer/customer-group-detail', group ? group.cg_id : '']);
    };
    CustomerGroupComponent.prototype.openListCustomerModal = function (customerGroup) {
    ...
    CustomerGroupComponent.prototype.openConfirmModal = function (customerGroup) {
        var _this = this;
        sweetalert2__WEBPACK_IMPORTED_MODULE_9___default.a.fire({
            ...
            if (result.value) {
                _this._removeCustomerGroup(customerGroup);
            }
        });
    };
    CustomerGroupComponent.prototype.onChangeFilter = function () {
        this._fetchData();
    };
    CustomerGroupComponent.prototype._fetchData = function () {
        var _this = this;
        var customerGroup$ = this.customerGroupService
            .loadCustomerGroup({
            pageNumber: this.page,
            pageSize: this.pageSize,
            cg_id: '',
        ...
        customerGroup$.subscribe(function (res) {
            if (res && res.Data) {
                ...
                _this.groups = res.Data.Results;
            }
        });
    };
    CustomerGroupComponent.prototype._fetchChart = function () {
        var _this = this;
        this.simplePieChart = _data__WEBPACK_IMPORTED_MODULE_3__["simplePieChart"];
        var chart$ = this.customerGroupService.loadChart().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["takeUntil"])(this.destroyed$));
        chart$.subscribe(function (res) {
            if (res && res.Data) {
                _this.simplePieChart.series = [];
                _this.simplePieChart.labels = [];
                res.Data.map(function (e) {
                    _this.simplePieChart.series.push(e.number);
                    _this.simplePieChart.labels.push(e.cg_name);
                });
            }
        });
    };
    CustomerGroupComponent.prototype._removeCustomerGroup = function (customerGroup) {
        var _this = this;
        var removeCustomerGroup$ = this.customerGroupService
            .removeCustomerGroup({ cg_id: customerGroup.cg_id })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["takeUntil"])(this.destroyed$));
        removeCustomerGroup$.subscribe(function (res) {
            if (res && res.Code === 200) {
                _this._notify(true, res.Message);
                _this._fetchData();
                _this._fetchChart();
    ...
    CustomerGroupComponent.prototype._notify = function (isSuccess, message) {
...
var menu = ['Thông tin chung', 'Địa chỉ', 'Số điện thoại', 'Địa chỉ nhận hàng'];
...
module.exports = ":host .card-body {\n  padding: 0;\n}\n:host .customer-detail {\n  display: flex;\n  height: 100%;\n}\n:host .customer-detail .menu {\n  width: 200px;\n  border-right: 2px solid lightgray;\n}\n:host .customer-detail .menu .item {\n  font-size: small;\n  cursor: pointer;\n  padding: 10px;\n}\n:host .customer-detail .menu .item:hover {\n  background-color: lightgrey;\n  font-weight: 700;\n}\n:host .customer-detail .menu .item.is-selected {\n  background-color: lightgray;\n}\n:host .customer-detail .main {\n  width: 100%;\n  max-height: 100%;\n}\n:host .customer-detail .content {\n  height: calc(100% - 40px);\n  overflow: auto;\n  padding-left: 20px;\n}\n:host .customer-detail .content .row {\n  margin: 0;\n}\n:host .customer-detail .content .form-row {\n  margin: 0;\n}\n:host .customer-detail .content span {\n  color: red;\n}\n:host .customer-detail .content .title-section {\n  padding: 5px 0px;\n  align-items: center;\n}\n:host .customer-detail .content .title-section i {\n  font-size: medium;\n  cursor: pointer;\n}\n:host .customer-detail .content .form-inline {\n  align-items: baseline;\n  flex-flow: row;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var ListCustomerDetailComponent = /** @class */ (function () {
    function ListCustomerDetailComponent(route, router, formBuilder, addressService, customerService, modalService) {
        this.route = route;
        this.router = router;
        this.formBuilder = formBuilder;
    ...
    ListCustomerDetailComponent.prototype.ngOnInit = function () {
    ...
    ListCustomerDetailComponent.prototype.ngOnDestroy = function () {
        this.destroyed$.next();
        this.destroyed$.complete();
    };
    ListCustomerDetailComponent.prototype.onClickMenuItem = function (index) {
        this.selectedMenuItem = index;
        var el = document.getElementById(index);
        var content = document.getElementById('content');
        content.scroll({ top: el.offsetTop - 50, behavior: 'smooth' });
    };
    ListCustomerDetailComponent.prototype.switchViewType = function (index) {
        this.listView[index] = !this.listView[index];
    };
    ListCustomerDetailComponent.prototype.onChangeToMain = function () {
        var _this = this;
        if (this.formProfile.dirty || this.formAddress.dirty || this.isChange) {
            sweetalert2__WEBPACK_IMPORTED_MODULE_11___default.a.fire({
                ...
                if (result.value) {
                    _this.router.navigate(['/customer/list-customer']);
                }
            });
        }
        else {
    ...
    ListCustomerDetailComponent.prototype.onSubmit = function () {
        this.submitted = true;
        ...
        var data = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, profileForm, this.formAddress.value, { list_customer_phone: this.listMobile, list_ship_address: this.listAddress });
        console.log(data);
        if (this.cu_id)
            this._updateCustomer(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, data, { cu_id: this.cu_id }));
        else
    ...
    //#endregion
    //#region  Address
    ListCustomerDetailComponent.prototype.onChangeProvince = function (e) {
        var districtId = this.province.find(function (item) { return item.name === e.target.value; }).id;
        this._loadDistrict(districtId);
    };
    ListCustomerDetailComponent.prototype.onChangeDistrict = function (e) {
        var wardId = this.district.find(function (item) { return item.name === e.target.value; }).id;
        this._loadWard(wardId);
    };
    //#endregion
    //#region List Mobile
    ListCustomerDetailComponent.prototype.openMobileModal = function (mobile) {
        var _this = this;
        var modalRef = this.modalService.open(_list_customer_component_mobile_modal_mobile_modal_component__WEBPACK_IMPORTED_MODULE_9__["MobileModalComponent"], {
            centered: true,
        });
        ...
        modalRef.componentInstance.passEvent.subscribe(function (res) {
            if (res.event) {
                if (mobile) {
                    _this.listMobile = _this.listMobile.map(function (item) {
                    ...
                    _this.listMobile.push(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, res.data, { cp_id: "temp_" + _this.tempMobile }));
                    _this.tempMobile++;
                    _this.isChange = true;
                }
            }
    ...
    ListCustomerDetailComponent.prototype.onRemoveMobile = function (mobile) {
        var _this = this;
        sweetalert2__WEBPACK_IMPORTED_MODULE_11___default.a.fire({
            ...
            if (result.value) {
                _this.listMobile = _this.listMobile.filter(function (item) { return item.cp_id !== mobile.cp_id; });
                _this.isChange = true;
            }
        });
    };
    //#endregion
    //#region List Address
    ListCustomerDetailComponent.prototype.openAddressModal = function (address) {
        var _this = this;
        var modalRef = this.modalService.open(_list_customer_component_addres_modal_addres_modal_component__WEBPACK_IMPORTED_MODULE_10__["AddresModalComponent"], {
            centered: true,
        });
        ...
        modalRef.componentInstance.passEvent.subscribe(function (res) {
            if (res.event) {
                if (address) {
                    ...
                    _this.listAddress.push(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, res.form, { sha_id: "temp_" + _this.tempAddress }));
                    _this.tempAddress++;
                    _this.isChange = true;
                }
            }
    ...
    ListCustomerDetailComponent.prototype.onRemoveAddress = function (address) {
        var _this = this;
        sweetalert2__WEBPACK_IMPORTED_MODULE_11___default.a.fire({
            ...
            if (result.value) {
                _this.listAddress = _this.listAddress.filter(function (item) { return item.sha_id !== address.sha_id; });
                _this.isChange = true;
            }
        });
    };
    //#endregion
    //#region Private
    ListCustomerDetailComponent.prototype._initializeForm = function () {
    ...
    ListCustomerDetailComponent.prototype._fetchFilter = function () {
        var _this = this;
        var source$ = this.customerService.loadSource().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.destroyed$));
        source$.subscribe(function (res) {
            _this.sources = res.Data;
        });
        var customerGroup$ = this.customerService.loadGroup().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.destroyed$));
        customerGroup$.subscribe(function (res) {
            _this.customerGroups = res.Data;
        });
    };
    ListCustomerDetailComponent.prototype._fetchCustomer = function (cu_id) {
        var _this = this;
        var info$ = this.customerService.loadCustomerInfo({ cu_id: cu_id }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.destroyed$));
        info$.subscribe(function (res) {
            if (res && res.Data) {
                _this._patchCustomer(res.Data);
            }
        });
    };
    ListCustomerDetailComponent.prototype._patchCustomer = function (customer) {
    ...
    ListCustomerDetailComponent.prototype._loadProvince = function () {
        var _this = this;
        var province$ = this.addressService.loadProvince().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.destroyed$));
        province$.subscribe(function (res) {
            if (res && res.Data) {
                _this.province = res.Data;
                if (_this.formAddress.value.sha_province_now === null) {
                    _this.formAddress.patchValue({ sha_province_now: res.Data[0].name });
                    _this._loadDistrict(res.Data[0].id);
                }
                else {
                    var provinceId = _this.province.find(function (item) { return item.name === _this.formAddress.value.sha_province_now; }).id;
                    _this._loadDistrict(provinceId, true);
                }
            }
        });
    };
    ListCustomerDetailComponent.prototype._loadDistrict = function (provinceId, isFirst) {
        var _this = this;
        ...
        district$.subscribe(function (res) {
            if (res && res.Data) {
                ...
                if (_this.formAddress.value.sha_district_now === null || !isFirst) {
                    _this.formAddress.patchValue({ sha_district_now: res.Data[0].name });
                    _this._loadWard(res.Data[0].id);
                }
                else {
                    var districtId = _this.district.find(function (item) { return item.name === _this.formAddress.value.sha_district_now; }).id;
                    _this._loadWard(districtId, true);
                }
            }
        });
    };
    ListCustomerDetailComponent.prototype._loadWard = function (districtId, isFirst) {
        var _this = this;
        if (isFirst === void 0) { isFirst = false; }
        ...
        ward$.subscribe(function (res) {
            if (res && res.Data) {
                _this.ward = res.Data;
                if (_this.formAddress.value.sha_ward_now === null || !isFirst) {
                    _this.formAddress.patchValue({ sha_ward_now: res.Data[0].name });
                }
            }
        });
    };
    ListCustomerDetailComponent.prototype._createCustomer = function (data) {
        var _this = this;
    ...
    ListCustomerDetailComponent.prototype._updateCustomer = function (updated) {
        var _this = this;
    ...
    ListCustomerDetailComponent.prototype._convertNgbDateToDate = function (ngbDate) {
        if (!ngbDate) {
            return '';
        }
    ...
    ListCustomerDetailComponent.prototype._convertDateToNgbDate = function (date) {
        if (!date) {
            return null;
        }
        var year = moment__WEBPACK_IMPORTED_MODULE_12__(date).year();
        var month = moment__WEBPACK_IMPORTED_MODULE_12__(date).month() + 1;
        var day = moment__WEBPACK_IMPORTED_MODULE_12__(date).date();
        return new _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_4__["NgbDate"](year, month, day);
    };
    ListCustomerDetailComponent.prototype._notify = function (isSuccess, message) {
    ...
    ListCustomerDetailComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"] },
    ...
    return ListCustomerDetailComponent;
}());
...
var AddresModalComponent = /** @class */ (function () {
    ...
    AddresModalComponent.prototype.onClickSubmit = function () {
        ...
        this.listAddress.forEach(function (item) {
            if (item.sha_province === _this.form.value.sha_province &&
                item.sha_district === _this.form.value.sha_district &&
                item.sha_ward === _this.form.value.sha_ward &&
                item.sha_detail.trim() === _this.form.value.sha_detail.trim())
                isConflict = true;
        });
        if (isConflict)
    ...
    AddresModalComponent.prototype._notify = function (isSuccess, message) {
...
module.exports = ":host a.diabled {\n  cursor: default;\n  pointer-events: none;\n}\n:host .row {\n  margin-right: 0;\n}\n:host .table-responsive {\n  overflow: auto;\n  max-height: calc(100% - 85px);\n}\n:host .table {\n  border-collapse: separate;\n  border-spacing: 0;\n}\n:host .table thead th {\n  position: -webkit-sticky;\n  position: sticky;\n  top: 0;\n  z-index: 2;\n  background-color: white;\n}\n:host .table tr {\n  cursor: pointer;\n}\n:host .table tr.is-selected {\n  background-color: lightgray;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var AddressTabComponent = /** @class */ (function () {
    function AddressTabComponent(modalService) {
        this.modalService = modalService;
    ...
    AddressTabComponent.prototype.ngOnChanges = function () {
        ...
        if (this.selectedAddress)
            this.selectedAddress = this.listAddress.filter(function (item) { return item.sha_id === _this.selectedAddress.sha_id; })[0];
    };
    ...
    AddressTabComponent.prototype._removeAddress = function (address) {
        var updatedList = this.listAddress.filter(function (item) { return item.sha_id !== address.sha_id; });
        this.formSubmit.emit(updatedList);
    };
...
module.exports = ":host .table-responsive {\n  overflow: auto;\n  max-height: calc(100% - 85px);\n}\n:host .table {\n  border-collapse: separate;\n  border-spacing: 0;\n}\n:host .table thead th {\n  position: -webkit-sticky;\n  position: sticky;\n  top: 0;\n  z-index: 2;\n  background-color: white;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ":host span {\n  color: red;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var MobileModalComponent = /** @class */ (function () {
    function MobileModalComponent(formBuilder) {
        this.formBuilder = formBuilder;
        this.passEvent = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.submitted = false;
        this.initializeForm();
    }
    MobileModalComponent.prototype.ngOnInit = function () {
        if (this.mobile) {
            this.patchData(this.mobile);
        }
    };
    MobileModalComponent.prototype.changePhoneType = function (event) {
        var type = event.target.value;
        this.form.patchValue({
            cp_type_name: type === '1' ? 'Số chính' : type === '2' ? 'Số nhà' : 'Số công ty',
        });
    };
    MobileModalComponent.prototype.onClickSubmit = function () {
        var _this = this;
        this.submitted = true;
        var isConflict = false;
        this.listMobile.forEach(function (item) {
            if (item.cp_phone_number.trim() === _this.form.value.cp_phone_number.trim())
                isConflict = true;
        });
        if (isConflict)
    ...
    MobileModalComponent.prototype.onClickCancel = function () {
        var _this = this;
        if (this.form.dirty) {
            sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
                title: 'Dữ liệu đã bị thay đổi, bạn có chắc chắn muốn hủy thao tác không?',
    ...
    Object.defineProperty(MobileModalComponent.prototype, "formUI", {
        get: function () {
            return this.form.controls;
        },
        enumerable: true,
    ...
    MobileModalComponent.prototype.initializeForm = function () {
        this.form = this.formBuilder.group({
            cp_id: ['temp_0', null],
    ...
    MobileModalComponent.prototype.patchData = function (mobile) {
        this.form.patchValue({
            cp_id: mobile.cp_id,
    ...
    MobileModalComponent.prototype._notify = function (isSuccess, message) {
    ...
    MobileModalComponent.ctorParameters = function () { return [
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
...
module.exports = ":host a.diabled {\n  cursor: default;\n  pointer-events: none;\n}\n:host .row {\n  margin-right: 0;\n}\n:host .table-responsive {\n  overflow: auto;\n  max-height: calc(100% - 85px);\n}\n:host .table tr {\n  cursor: pointer;\n}\n:host .table tr.is-selected {\n  background-color: lightgray;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var MobileTabComponent = /** @class */ (function () {
    function MobileTabComponent(modalService) {
        this.modalService = modalService;
        this.formSubmit = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.selectedMobile = null;
    }
    MobileTabComponent.prototype.ngOnInit = function () { };
    MobileTabComponent.prototype.ngOnChanges = function () {
        var _this = this;
        if (!this.customerId)
            this.selectedMobile = null;
        if (this.selectedMobile)
            this.selectedMobile = this.listMobile.filter(function (item) { return item.cp_id === _this.selectedMobile.cp_id; })[0];
    };
    MobileTabComponent.prototype.onClickMobile = function (mobile) {
    ...
    MobileTabComponent.prototype.openMobileModal = function (mobile) {
        var _this = this;
        var modalRef = this.modalService.open(_mobile_modal_mobile_modal_component__WEBPACK_IMPORTED_MODULE_3__["MobileModalComponent"], {
            centered: true,
        });
        modalRef.componentInstance.listMobile = this.listMobile;
        if (mobile) {
        ...
        modalRef.componentInstance.passEvent.subscribe(function (res) {
            if (res.event) {
                if (mobile) {
                    _this._updateMobile(res.data);
                }
                else {
                    _this._createMobile(res.data);
                }
            }
            modalRef.close();
        });
    };
    MobileTabComponent.prototype.openConfirmModal = function (mobile) {
        var _this = this;
        sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.fire({
            title: 'Chắc chắn muốn xóa số điện thoại đang chọn?',
            type: 'warning',
            ...
            if (result.value) {
                _this._removeMobile(mobile);
            }
        });
    };
    MobileTabComponent.prototype._createMobile = function (data) {
        var updatedList = this.listMobile.concat(data);
        this.formSubmit.emit(updatedList);
    };
    MobileTabComponent.prototype._updateMobile = function (updated) {
        var updatedList = this.listMobile.map(function (item) {
    ...
    MobileTabComponent.prototype._removeMobile = function (mobile) {
        var updatedList = this.listMobile.filter(function (item) { return item.cp_id !== mobile.cp_id; });
        this.formSubmit.emit(updatedList);
    };
    MobileTabComponent.ctorParameters = function () { return [
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbModal"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
...
module.exports = ":host .order-container {\n  text-decoration: underline;\n  cursor: pointer;\n  color: darkblue;\n  font-weight: bold;\n}\n:host .back-container {\n  cursor: pointer;\n  color: darkblue;\n  font-weight: bold;\n}\n:host .row {\n  margin-right: 0;\n  margin-left: 0;\n}\n:host .table-responsive {\n  overflow: auto;\n  max-height: calc(100% - 85px);\n  border-collapse: separate;\n  border-spacing: 0;\n}\n:host .table-responsive thead th {\n  position: -webkit-sticky;\n  position: sticky;\n  top: 0;\n  z-index: 2;\n  background-color: white;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var PurchaseHistoryTabComponent = /** @class */ (function () {
    function PurchaseHistoryTabComponent() {
...
module.exports = ":host .order-container {\n  text-decoration: underline;\n  cursor: pointer;\n  color: darkblue;\n  font-weight: bold;\n}\n:host .back-container {\n  cursor: pointer;\n  color: darkblue;\n  font-weight: bold;\n}\n:host .row {\n  margin-right: 0;\n  margin-left: 0;\n}\n:host .table-responsive {\n  overflow: auto;\n  max-height: calc(100% - 55px);\n  border-collapse: separate;\n  border-spacing: 0;\n}\n:host .table-responsive thead th {\n  position: -webkit-sticky;\n  position: sticky;\n  top: 0;\n  z-index: 2;\n  background-color: white;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var ServiceHistoryTabComponent = /** @class */ (function () {
    function ServiceHistoryTabComponent() {
        this.selectedOrder = null;
    }
    ServiceHistoryTabComponent.prototype.ngOnInit = function () { };
    ServiceHistoryTabComponent.prototype.onClickOrder = function (order) {
        this.selectedOrder = order;
    };
    ServiceHistoryTabComponent.prototype.onClickBack = function () {
        this.selectedOrder = null;
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
    ...
    return ServiceHistoryTabComponent;
}());
...
module.exports = ":host .card-body {\n  padding: 0;\n  padding-top: 10px;\n}\n:host .form-inline {\n  align-items: baseline;\n}\n:host a.diabled {\n  cursor: default;\n  pointer-events: none;\n}\n:host .table-responsive {\n  overflow: auto;\n  max-height: calc(100% - 150px);\n}\n:host .table-responsive table {\n  min-width: 1300px;\n  border-spacing: 0;\n  border-collapse: separate;\n}\n:host .table-responsive thead th {\n  position: -webkit-sticky;\n  position: sticky;\n  top: 0;\n  z-index: 2;\n  background-color: white;\n}\n:host .table-responsive tr {\n  cursor: pointer;\n}\n:host .table-responsive tr.is-selected {\n  background-color: lightgray;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var ListCustomerComponent = /** @class */ (function () {
    ...
    ListCustomerComponent.prototype.ngOnDestroy = function () {
        this.destroyed$.next();
        this.destroyed$.complete();
    };
    ...
    ListCustomerComponent.prototype.onRouteDetail = function (customer) {
    ...
    ListCustomerComponent.prototype.onChangeAddress = function (event) {
        var updated = this.selectedCustomer;
        updated.list_ship_address = event;
        this._updateCustomer(updated);
    };
    ListCustomerComponent.prototype.onChangeMobile = function (event) {
        var updated = this.selectedCustomer;
    ...
    ListCustomerComponent.prototype.setFile = function (event) {
        ...
        var import$ = this.customerService.importCustomer(files[0]).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.destroyed$));
    ...
    ListCustomerComponent.prototype.exportCustomer = function () {
        var export$ = this.customerService
            .exportCustomer({
    ...
    ListCustomerComponent.prototype.exportTemplate = function () {
        var export$ = this.customerService.exportTemplate().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.destroyed$));
        export$.subscribe(function (res) {
            if (res && res.Data) {
                var link = 'http://27.72.147.222:1230/' + res.Data;
                window.open(link);
    ...
    ListCustomerComponent.prototype._fetchFilter = function () {
        var _this = this;
        var sources$ = this.customerService.loadSource().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.destroyed$));
        sources$.subscribe(function (res) {
            _this.sources = res.Data;
        });
        var group$ = this.customerService.loadGroup().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.destroyed$));
    ...
    ListCustomerComponent.prototype._notify = function (isSuccess, message) {
    ...
    ListCustomerComponent.prototype._convertDateToNgbDate = function (date) {
        if (!date) {
            return null;
        }
        var year = moment__WEBPACK_IMPORTED_MODULE_7__(date).year();
        var month = moment__WEBPACK_IMPORTED_MODULE_7__(date).month() + 1;
        var day = moment__WEBPACK_IMPORTED_MODULE_7__(date).date();
        return new _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbDate"](year, month, day);
    };
    ListCustomerComponent.prototype._convertNgbDateToDate = function (ngbDate) {
        if (!ngbDate) {
            return '';
        }
...
module.exports = ":host .card-body {\n  padding: 0;\n}\n:host .main {\n  padding: 10px;\n  padding-top: 20px;\n  max-height: calc(100vh - 70px);\n  overflow: auto;\n}\n:host span {\n  color: red;\n}\n:host i {\n  cursor: pointer;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var ListTransactionProductDetailComponent = /** @class */ (function () {
    function ListTransactionProductDetailComponent(route, router, formBuilder, transactionService, customerService) {
        this.route = route;
        this.router = router;
        this.formBuilder = formBuilder;
    ...
    ListTransactionProductDetailComponent.prototype.ngOnInit = function () {
    ...
    ListTransactionProductDetailComponent.prototype.ngOnDestroy = function () {
        this.destroyed$.next();
        this.destroyed$.complete();
    };
    ListTransactionProductDetailComponent.prototype.onChangeToMain = function () {
        var _this = this;
        if (this.form.dirty) {
            sweetalert2__WEBPACK_IMPORTED_MODULE_7___default.a.fire({
                title: 'Dữ liệu đã bị thay đổi, bạn có chắc chắn muốn hủy thao tác không?',
                ...
                if (result.value) {
                    _this.router.navigate(['/customer/list-transaction-product']);
                }
            });
        }
        else {
    ...
    ListTransactionProductDetailComponent.prototype.onSubmit = function () {
        this.submitted = true;
        if (this.form.invalid)
            return;
        ...
        var data = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ customer: this.selectedCustomer }, this.form.value);
        console.log(data);
        if (this.tra_id)
            this._updateTransaction(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, data, { tra_id: this.tra_id }));
        else
            this._createTransaction(data);
    };
    ListTransactionProductDetailComponent.prototype.changeDatalistCustomer = function (e) {
        if (e.target.value === '') {
            this.selectedCustomer = null;
        }
        else {
    ...
    //#region  Private
    ListTransactionProductDetailComponent.prototype.initializeForm = function () {
        this.form = this.formBuilder.group({
    ...
    ListTransactionProductDetailComponent.prototype._fetchTransaction = function (tra_id) {
        var _this = this;
        var info$ = this.transactionService
            .loadTransactionInfo({ tra_id: tra_id })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.destroyed$));
        info$.subscribe(function (res) {
            if (res && res.Data) {
                _this._patchTransaction(res.Data);
            }
        });
    };
    ListTransactionProductDetailComponent.prototype._patchTransaction = function (data) {
    ...
    ListTransactionProductDetailComponent.prototype._fetchFilter = function () {
        var _this = this;
        var type$ = this.transactionService.loadType().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.destroyed$));
        type$.subscribe(function (res) {
            _this.types = res.Data;
        });
        var status$ = this.transactionService.loadStatus().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.destroyed$));
        status$.subscribe(function (res) {
            _this.statuses = res.Data;
        });
        var priority$ = this.transactionService.loadPriority().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.destroyed$));
        priority$.subscribe(function (res) {
            _this.priorities = res.Data;
        });
        var rate$ = this.transactionService.loadRate().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.destroyed$));
        rate$.subscribe(function (res) {
            _this.rates = res.Data;
        });
        var customer$ = this.customerService
    ...
    ListTransactionProductDetailComponent.prototype._fetchCustomer = function (cu_id) {
        var _this = this;
    ...
    ListTransactionProductDetailComponent.prototype._createTransaction = function (data) {
        var _this = this;
        var createTransaction$ = this.transactionService
            .createTransaction(data)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.destroyed$));
        createTransaction$.subscribe(function (res) {
            if (res && res.Code === 200) {
                _this._notify(true, res.Message);
                _this.router.navigate(['/customer/list-transaction-product']);
            }
    ...
    ListTransactionProductDetailComponent.prototype._updateTransaction = function (updated) {
        var _this = this;
    ...
    ListTransactionProductDetailComponent.prototype._notify = function (isSuccess, message) {
        return sweetalert2__WEBPACK_IMPORTED_MODULE_7___default.a.fire({
            toast: true,
            position: 'top-end',
            type: isSuccess ? 'success' : 'error',
    ...
    ListTransactionProductDetailComponent.ctorParameters = function () { return [
    ...
    return ListTransactionProductDetailComponent;
}());
...
module.exports = ":host .card-body {\n  padding: 0;\n  padding-top: 10px;\n}\n:host .form-inline {\n  align-items: baseline;\n}\n:host a.diabled {\n  cursor: default;\n  pointer-events: none;\n}\n:host .table-responsive {\n  overflow: auto;\n  max-height: calc(100% - 150px);\n}\n:host .table-responsive table {\n  min-width: 1400px;\n  border-spacing: 0;\n  border-collapse: separate;\n}\n:host .table-responsive thead th {\n  position: -webkit-sticky;\n  position: sticky;\n  top: 0;\n  z-index: 2;\n  background-color: white;\n}\n:host .table-responsive tr {\n  cursor: pointer;\n}\n:host .table-responsive tr.is-selected {\n  background-color: lightgray;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var ListTransactionProductComponent = /** @class */ (function () {
    function ListTransactionProductComponent(modalService, transactionService, router) {
        this.modalService = modalService;
        this.transactionService = transactionService;
        this.router = router;
    ...
    ListTransactionProductComponent.prototype.ngOnInit = function () {
        this._fetchData();
    };
    ListTransactionProductComponent.prototype.ngOnDestroy = function () {
        this.destroyed$.next();
        this.destroyed$.complete();
    };
    ListTransactionProductComponent.prototype.onClickOrder = function (transaction) {
    ...
    ListTransactionProductComponent.prototype.onRouteDetail = function (transaction) {
        this.router.navigate([
            '/customer/list-transaction-product-detail',
            transaction ? transaction.tra_id : '',
        ]);
    };
    ListTransactionProductComponent.prototype.openConfirmModal = function (transaction) {
        var _this = this;
        sweetalert2__WEBPACK_IMPORTED_MODULE_6___default.a.fire({
    ...
    ListTransactionProductComponent.prototype.onPageChange = function (page) {
        this.page = page;
        this._fetchData();
    };
    ListTransactionProductComponent.prototype.onChangeFilter = function () {
        this._fetchData(this.selectedTransaction);
    };
    ListTransactionProductComponent.prototype.exportTransaction = function () {
    ...
    ListTransactionProductComponent.prototype._fetchData = function (selected) {
        var _this = this;
        ...
        transaction$.subscribe(function (res) {
            if (res && res.Data) {
                ...
                if (selected) {
                    _this.selectedTransaction = _this.transactions.find(function (item) { return item.tra_id === selected.tra_id; });
                }
                else {
                    _this.selectedTransaction = _this.transactions[0];
                }
            }
        });
    };
    ListTransactionProductComponent.prototype._removeTransaction = function (transaction) {
        var _this = this;
    ...
    ListTransactionProductComponent.prototype._notify = function (isSuccess, message) {
        return sweetalert2__WEBPACK_IMPORTED_MODULE_6___default.a.fire({
            toast: true,
            position: 'top-end',
            type: isSuccess ? 'success' : 'error',
    ...
    ListTransactionProductComponent.prototype._convertDateToNgbDate = function (date) {
        if (!date) {
            return null;
        }
        var year = moment__WEBPACK_IMPORTED_MODULE_7__(date).year();
    ...
    ListTransactionProductComponent.prototype._convertNgbDateToDate = function (ngbDate) {
        if (!ngbDate) {
            return '';
        }
    ...
    ListTransactionProductComponent.ctorParameters = function () { return [
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbModal"] },
    ...
    return ListTransactionProductComponent;
}());
...
module.exports = ":host .card-body {\n  padding: 0;\n}\n:host .main {\n  padding: 10px;\n  padding-top: 20px;\n  max-height: calc(100vh - 70px);\n  overflow: auto;\n}\n:host span {\n  color: red;\n}\n:host i {\n  cursor: pointer;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var ListTransactionServiceDetailComponent = /** @class */ (function () {
    function ListTransactionServiceDetailComponent(route, router, formBuilder, transactionService, customerService) {
        this.route = route;
        this.router = router;
        this.formBuilder = formBuilder;
        this.transactionService = transactionService;
    ...
    ListTransactionServiceDetailComponent.prototype.ngOnInit = function () {
        this.tra_id = this.route.snapshot.paramMap.get('tra_id');
        if (this.tra_id === '')
            this.isView = false;
        this.initializeForm();
    ...
    ListTransactionServiceDetailComponent.prototype.ngOnDestroy = function () {
        this.destroyed$.next();
        this.destroyed$.complete();
    };
    ListTransactionServiceDetailComponent.prototype.onChangeToMain = function () {
        var _this = this;
        if (this.form.dirty) {
            sweetalert2__WEBPACK_IMPORTED_MODULE_7___default.a.fire({
                title: 'Dữ liệu đã bị thay đổi, bạn có chắc chắn muốn hủy thao tác không?',
                ...
                if (result.value) {
                    _this.router.navigate(['/customer/list-transaction-service']);
                }
            });
        }
        else {
    ...
    ListTransactionServiceDetailComponent.prototype.onSubmit = function () {
        this.submitted = true;
        if (this.form.invalid)
            return;
        if (this.selectedCustomer === null)
    ...
    ListTransactionServiceDetailComponent.prototype.changeDatalistCustomer = function (e) {
        if (e.target.value === '') {
            this.selectedCustomer = null;
        }
        else {
    ...
    //#region  Private
    ListTransactionServiceDetailComponent.prototype.initializeForm = function () {
        this.form = this.formBuilder.group({
            tra_title: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
            tra_type: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
            tra_priority: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
    ...
    ListTransactionServiceDetailComponent.prototype._fetchTransaction = function (tra_id) {
        var _this = this;
        var info$ = this.transactionService
            .loadTransactionInfo({ tra_id: tra_id })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.destroyed$));
    ...
    ListTransactionServiceDetailComponent.prototype._patchTransaction = function (data) {
        this.searchCustomer = data.customer ? data.customer.cu_id : '';
        this.selectedCustomer = data.customer;
        this.form.patchValue({
            tra_title: data.tra_title,
    ...
    ListTransactionServiceDetailComponent.prototype._fetchFilter = function () {
        var _this = this;
        var type$ = this.transactionService.loadType().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.destroyed$));
        type$.subscribe(function (res) {
            _this.types = res.Data;
    ...
    ListTransactionServiceDetailComponent.prototype._fetchCustomer = function (cu_id) {
        var _this = this;
        var customer$ = this.transactionService
            .loadCustomer({ cu_id: cu_id })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.destroyed$));
    ...
    ListTransactionServiceDetailComponent.prototype._createTransaction = function (data) {
        var _this = this;
        var createTransaction$ = this.transactionService
            .createTransaction(data)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.destroyed$));
    ...
    ListTransactionServiceDetailComponent.prototype._updateTransaction = function (updated) {
        var _this = this;
        var updateTransaction$ = this.transactionService
            .updateTransaction(updated)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.destroyed$));
    ...
    ListTransactionServiceDetailComponent.prototype._notify = function (isSuccess, message) {
        return sweetalert2__WEBPACK_IMPORTED_MODULE_7___default.a.fire({
            toast: true,
            position: 'top-end',
            type: isSuccess ? 'success' : 'error',
    ...
    ListTransactionServiceDetailComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_9__["ActivatedRoute"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_9__["Router"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: _core_services_api_transaction_service__WEBPACK_IMPORTED_MODULE_3__["TransactionService"] },
    ...
    return ListTransactionServiceDetailComponent;
}());
...
module.exports = ":host .card-body {\n  padding: 0;\n  padding-top: 10px;\n}\n:host .form-inline {\n  align-items: baseline;\n}\n:host a.diabled {\n  cursor: default;\n  pointer-events: none;\n}\n:host .table-responsive {\n  overflow: auto;\n  max-height: calc(100% - 150px);\n}\n:host .table-responsive table {\n  min-width: 1400px;\n  border-spacing: 0;\n  border-collapse: separate;\n}\n:host .table-responsive thead th {\n  position: -webkit-sticky;\n  position: sticky;\n  top: 0;\n  z-index: 2;\n  background-color: white;\n}\n:host .table-responsive tr {\n  cursor: pointer;\n}\n:host .table-responsive tr.is-selected {\n  background-color: lightgray;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var ListTransactionServiceComponent = /** @class */ (function () {
    function ListTransactionServiceComponent(modalService, transactionService, router) {
        this.modalService = modalService;
        this.transactionService = transactionService;
        this.router = router;
        this.destroyed$ = new rxjs__WEBPACK_IMPORTED_MODULE_3__["Subject"]();
    ...
    ListTransactionServiceComponent.prototype.ngOnInit = function () {
        this._fetchData();
    };
    ListTransactionServiceComponent.prototype.ngOnDestroy = function () {
        this.destroyed$.next();
        this.destroyed$.complete();
    };
    ListTransactionServiceComponent.prototype.onClickOrder = function (transaction) {
        if (Object(util__WEBPACK_IMPORTED_MODULE_8__["isNullOrUndefined"])(this.selectedTransaction)) {
            this.selectedTransaction = transaction;
        }
        else {
    ...
    ListTransactionServiceComponent.prototype.onRouteDetail = function (transaction) {
        this.router.navigate([
            '/customer/list-transaction-service-detail',
            transaction ? transaction.tra_id : '',
        ]);
    };
    ListTransactionServiceComponent.prototype.openConfirmModal = function (transaction) {
        var _this = this;
        sweetalert2__WEBPACK_IMPORTED_MODULE_6___default.a.fire({
            title: 'Chắc chắn muốn xóa giao dịch khách hàng đang chọn?',
            type: 'warning',
    ...
    ListTransactionServiceComponent.prototype.onPageChange = function (page) {
        this.page = page;
        this._fetchData();
    };
    ListTransactionServiceComponent.prototype.onChangeFilter = function () {
        this._fetchData(this.selectedTransaction);
    };
    ListTransactionServiceComponent.prototype.exportTransaction = function () {
        var export$ = this.transactionService
            .exportTransaction({
            pageNumber: this.page - 1,
            pageSize: this.pageSize,
    ...
    ListTransactionServiceComponent.prototype._fetchData = function (selected) {
        var _this = this;
        var transaction$ = this.transactionService
            .searchTransaction({
            pageNumber: this.page - 1,
    ...
    ListTransactionServiceComponent.prototype._removeTransaction = function (transaction) {
        var _this = this;
        var removeTransaction$ = this.transactionService
            .removeTransaction({
            transactionId: transaction.tra_id,
    ...
    ListTransactionServiceComponent.prototype._notify = function (isSuccess, message) {
        return sweetalert2__WEBPACK_IMPORTED_MODULE_6___default.a.fire({
            toast: true,
            position: 'top-end',
            type: isSuccess ? 'success' : 'error',
    ...
    ListTransactionServiceComponent.prototype._convertDateToNgbDate = function (date) {
        if (!date) {
            return null;
        }
        var year = moment__WEBPACK_IMPORTED_MODULE_7__(date).year();
    ...
    ListTransactionServiceComponent.prototype._convertNgbDateToDate = function (ngbDate) {
        if (!ngbDate) {
            return '';
        }
        if (Object(util__WEBPACK_IMPORTED_MODULE_8__["isUndefined"])(ngbDate.year))
    ...
    ListTransactionServiceComponent.ctorParameters = function () { return [
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbModal"] },
        { type: _core_services_api_transaction_service__WEBPACK_IMPORTED_MODULE_5__["TransactionService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_9__["Router"] }
    ]; };
    ...
    return ListTransactionServiceComponent;
}());
...
//# sourceMappingURL=default~customer-customer-module~product-product-module~service-service-module-es5.js.map