...
var FullCalendarComponent = /** @class */ (function () {
    ...
    */
    ...
    FullCalendarComponent.propDecorators = {
        ...
        navLinkDayClick: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["Output"] }],
        navLinkWeekClick: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["Output"] }],
...
var ExecutorModalComponent = /** @class */ (function () {
    function ExecutorModalComponent(formBuilder, serviceService) {
    ...
    ExecutorModalComponent.prototype.ngOnInit = function () {
        if (this.exe) {
    ...
    ExecutorModalComponent.prototype.onChangeStaff = function (event) {
        var item = this.staffs.find(function (item) { return item.id === parseInt(event.target.value); });
        this.form.patchValue({
            staff_name: item.name,
        });
    };
    ExecutorModalComponent.prototype.onClickSubmit = function () {
        this.submitted = true;
        if (this.form.valid) {
    ...
    ExecutorModalComponent.prototype.onClickCancel = function () {
        var _this = this;
        if (this.form.dirty) {
    ...
    Object.defineProperty(ExecutorModalComponent.prototype, "formUI", {
        get: function () {
    ...
    ExecutorModalComponent.prototype.initializeForm = function () {
    ...
    ExecutorModalComponent.prototype.patchData = function (exe) {
        this.form.patchValue({
            exe_id: exe.exe_id,
    ...
    ExecutorModalComponent.prototype._loadStaff = function () {
        var _this = this;
        var list_staff_id = [];
        this.listSameDay.forEach(function (item) {
            if (item.staff_id)
        ...
        staff$.subscribe(function (res) {
            if (res && res.Data) {
                ...
                if (_this.exe.staff_id && _this.exe.staff_name)
                    _this.staffs.push({
                        id: parseInt(_this.exe.staff_id),
                        name: _this.exe.staff_name,
                    });
            }
        });
    };
    ExecutorModalComponent.ctorParameters = function () { return [
...
var menu = ['Thông tin khách hàng', 'Địa chỉ nhận hàng', 'Thông tin dịch vụ', 'Lịch làm việc'];
...
var ListOrderServiceDetailComponent = /** @class */ (function () {
    function ListOrderServiceDetailComponent(route, router, modalService, formBuilder, customerService, addressService, staffService, serviceService) {
        this.route = route;
        this.router = router;
    ...
    ListOrderServiceDetailComponent.prototype.ngOnInit = function () {
    ...
    ListOrderServiceDetailComponent.prototype.ngOnDestroy = function () {
        this.destroyed$.next();
        this.destroyed$.complete();
    };
    ListOrderServiceDetailComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        this.formRepeat.valueChanges.subscribe(function (data) { return _this._updateSummary(data); });
    };
    ListOrderServiceDetailComponent.prototype.onClickMenuItem = function (index) {
        this.selectedMenuItem = index;
        var el = document.getElementById(index);
        var content = document.getElementById('content');
        content.scroll({ top: el.offsetTop - 50, behavior: 'smooth' });
    };
    ListOrderServiceDetailComponent.prototype.switchViewType = function (index) {
        this.listView[index] = !this.listView[index];
    };
    ListOrderServiceDetailComponent.prototype.onChangeToMain = function () {
        var _this = this;
        if (this.formCustomer.dirty || this.formRepeat.dirty || this.isChange) {
            sweetalert2__WEBPACK_IMPORTED_MODULE_14___default.a.fire({
                ...
                if (result.value) {
                    _this.router.navigate(['/service/list-order-service']);
                }
            });
        }
        else {
    ...
    ListOrderServiceDetailComponent.prototype.onSubmit = function () {
        this.submitted = true;
        ...
        var repeatData = this.formRepeat.value;
        ...
        var data = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ cuo_color_show: this.cuo_color_show, cuo_discount: this.cuo_discount }, repeatData, { customer: tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, customerData, { list_customer_phone: this.listMobile, list_ship_address: this.listAddress }), list_service: this.listService, list_executor: this.listExecutor, cuo_infor_time: this.summary, cuo_address: this.cuo_address });
        console.log(data);
        if (this.cuo_id)
            this._updateOrderService(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, data, { cuo_id: this.cuo_id }));
        else
            this._createOrderService(data);
    };
    //#region Customer
    ListOrderServiceDetailComponent.prototype.onChangeProvince = function (e) {
        var districtId = this.province.find(function (item) { return item.name === e.target.value; }).id;
        this._loadDistrict(districtId);
    };
    ListOrderServiceDetailComponent.prototype.onChangeDistrict = function (e) {
        var wardId = this.district.find(function (item) { return item.name === e.target.value; }).id;
        this._loadWard(wardId);
    };
    ListOrderServiceDetailComponent.prototype.onClickCreateCustomer = function () {
    ...
    ListOrderServiceDetailComponent.prototype.changeDatalistCustomer = function (e) {
        this.isChange = true;
        if (!e || e.cu_id === '') {
    ...
    ListOrderServiceDetailComponent.prototype.openMobileModal = function (mobile) {
        var _this = this;
        var modalRef = this.modalService.open(_customer_list_customer_component_mobile_modal_mobile_modal_component__WEBPACK_IMPORTED_MODULE_8__["MobileModalComponent"], {
            centered: true,
        });
    ...
    ListOrderServiceDetailComponent.prototype.onRemoveMobile = function (mobile) {
        var _this = this;
        sweetalert2__WEBPACK_IMPORTED_MODULE_14___default.a.fire({
    ...
    //#endregion
    //#region List Address
    ListOrderServiceDetailComponent.prototype.onClickAddress = function (address) {
    ...
    ListOrderServiceDetailComponent.prototype.openAddressModal = function (address) {
        var _this = this;
        var modalRef = this.modalService.open(_customer_list_customer_component_addres_modal_addres_modal_component__WEBPACK_IMPORTED_MODULE_9__["AddresModalComponent"], {
            centered: true,
        });
    ...
    ListOrderServiceDetailComponent.prototype.onRemoveAddress = function (address) {
        var _this = this;
        sweetalert2__WEBPACK_IMPORTED_MODULE_14___default.a.fire({
    ...
    //#endregion
    //#region List Service
    ListOrderServiceDetailComponent.prototype.changeDatalistService = function (e) {
        this.searchService = { se_id: '', se_name: 'Chọn dịch vụ' };
        if (e.se_id !== '') {
            this.services = this.services.filter(function (item) { return item.se_id !== e.se_id; });
            this.listService.push(e);
            this.isChange = true;
        }
    };
    ListOrderServiceDetailComponent.prototype.onRemoveService = function (service) {
        var _this = this;
        sweetalert2__WEBPACK_IMPORTED_MODULE_14___default.a.fire({
            ...
            if (result.value) {
                _this.listService = _this.listService.filter(function (item) { return item.se_id !== service.se_id; });
                _this.services = _this.services.concat(service);
                _this.isChange = true;
            }
        });
    };
    //#endregion
    //#region Repeat
    ListOrderServiceDetailComponent.prototype.onClickWeekDay = function (day) {
        if (day === 'T2')
    ...
    ListOrderServiceDetailComponent.prototype.checkDay = function (day) {
        if (day === 'T2')
    ...
    ListOrderServiceDetailComponent.prototype.onChangeRepeatType = function (event) {
        if (event.target.value[0] === '2')
            this.onChangeDaySelection('T2');
        if (event.target.value[0] === '1')
            this.onChangeDaySelection('');
    };
    ListOrderServiceDetailComponent.prototype.onChangeDaySelection = function (event) {
        var day = event.target ? event.target.value : event;
        this.formRepeat.patchValue({
    ...
    ListOrderServiceDetailComponent.prototype.onChangeStartDate = function (event) {
        this.formRepeat.patchValue({
    ...
    ListOrderServiceDetailComponent.prototype.onGenerateWorkTime = function () {
        var _this = this;
        var repeatData = this.formRepeat.value;
        repeatData.st_start_date = this._convertNgbDateToDate(repeatData.st_start_date);
        repeatData.st_end_date = this._convertNgbDateToDate(repeatData.st_end_date);
        ...
        repeatData.st_on_day_flag = repeatData.st_on_day_flag ? 1 : 0;
        repeatData.st_on_the_flag = repeatData.st_on_day_flag ? 0 : 1;
        var genTime$ = this.serviceService
        ...
        genTime$.subscribe(function (res) {
            if (res && res.Data) {
                _this.listExecutor = res.Data.Results;
                _this.listExecutor = _this.listExecutor.map(function (item) {
                    _this.tempExecutor++;
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, item, { exe_id: "temp_" + _this.tempExecutor, start_time: item.start_time.substr(0, 5), end_time: item.end_time.substr(0, 5) });
                });
            }
        });
    };
    ListOrderServiceDetailComponent.prototype.onUpdateExe = function (exe) {
        var _this = this;
        var modalRef = this.modalService.open(_component_executor_modal_executor_modal_component__WEBPACK_IMPORTED_MODULE_7__["ExecutorModalComponent"], {
            centered: true,
        });
        var listSameDay = [];
        this.listExecutor.forEach(function (item) {
    ...
    ListOrderServiceDetailComponent.prototype.onDuplicateExe = function (exe, index) {
        this.tempExecutor++;
        var newItem = {
    ...
    ListOrderServiceDetailComponent.prototype.onRemoveExe = function (exe) {
        console.log(this.listExecutor);
        this.listExecutor = this.listExecutor.filter(function (item) { return item.exe_id !== exe.exe_id; });
        this.isChange = true;
    };
    ListOrderServiceDetailComponent.prototype._checkValidExecutor = function () {
        var res = true;
        this.listExecutor.forEach(function (item) {
    ...
    ListOrderServiceDetailComponent.prototype._updateSummary = function (data) {
        data.st_on_the_flag = data.st_on_day_flag === 1 ? 0 : 1;
        var st_repeat_type = data.st_repeat_type, st_sun_flag = data.st_sun_flag, st_mon_flag = data.st_mon_flag, st_tue_flag = data.st_tue_flag, st_wed_flag = data.st_wed_flag, st_thu_flag = data.st_thu_flag, st_fri_flag = data.st_fri_flag, st_sat_flag = data.st_sat_flag, st_repeat_every = data.st_repeat_every, st_on_the = data.st_on_the, st_on_day_flag = data.st_on_day_flag, st_on_day = data.st_on_day, st_on_the_flag = data.st_on_the_flag, st_custom_start = data.st_custom_start, st_custom_end = data.st_custom_end;
        var type = st_repeat_type === 1 ? 'ngày' : st_repeat_type === 2 ? 'tuần' : 'tháng';
        var startCustom = moment__WEBPACK_IMPORTED_MODULE_15__(this._convertNgbDateToDate(st_custom_start)).format('DD/MM');
        var endCustom = st_custom_end
    ...
    //#endregion
    //#region Private
    ListOrderServiceDetailComponent.prototype._initializeForm = function () {
    ...
    ListOrderServiceDetailComponent.prototype._fetchFilter = function () {
        var _this = this;
        ...
        var type$ = this.customerService.loadType().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.destroyed$));
        ...
        var service$ = this.serviceService
            .searchService(this.filterService)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.destroyed$));
        service$.subscribe(function (res) {
            _this.services = res.Data.Results;
            _this.services.push({ se_name: 'Chọn dịch vụ', se_id: '' });
            _this.services = _this.services.reverse();
            if (_this.listService) {
                _this.listService.forEach(function (item) {
                    _this.services = _this.services.filter(function (e) { return e.se_id !== item.se_id; });
                });
            }
        });
        var staff$ = this.staffService.loadAllStaff().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.destroyed$));
        staff$.subscribe(function (res) {
            _this.staffs = res.Data;
        });
    };
    ListOrderServiceDetailComponent.prototype._fetchOrderService = function (cuo_id) {
        var _this = this;
        var info$ = this.serviceService
            .loadOrderServiceInfo({ cuo_id: cuo_id })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.destroyed$));
        info$.subscribe(function (res) {
            if (res && res.Data) {
                _this._patchOrderService(res.Data);
            }
        });
    };
    ListOrderServiceDetailComponent.prototype._patchOrderService = function (orderService) {
        var _this = this;
        ...
        if (this.services) {
            this.listService.forEach(function (item) {
                _this.services = _this.services.filter(function (e) { return e.se_id !== item.se_id; });
            });
        }
        ...
        this.listExecutor = this.listExecutor.map(function (item) {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, item, { start_time: item.start_time.substr(0, 5), end_time: item.end_time.substr(0, 5) });
        });
    };
    ListOrderServiceDetailComponent.prototype._loadProvince = function () {
        var _this = this;
    ...
    ListOrderServiceDetailComponent.prototype._loadDistrict = function (provinceId, isFirst) {
        var _this = this;
    ...
    ListOrderServiceDetailComponent.prototype._loadWard = function (districtId, isFirst) {
        var _this = this;
        if (isFirst === void 0) { isFirst = false; }
    ...
    ListOrderServiceDetailComponent.prototype._createOrderService = function (data) {
        var _this = this;
        var createOrderService$ = this.serviceService
            .createOrderService(data)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.destroyed$));
        createOrderService$.subscribe(function (res) {
            if (res && res.Code == 200) {
    ...
    ListOrderServiceDetailComponent.prototype._updateOrderService = function (updated) {
        var _this = this;
        var updateOrderService$ = this.serviceService
            .updateOrderService(updated)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.destroyed$));
        updateOrderService$.subscribe(function (res) {
            if (res && res.Code == 200) {
                _this._notify(true, res.Message);
                _this.router.navigate(['/service/list-order-service']);
            }
    ...
    ListOrderServiceDetailComponent.prototype._fetchCustomer = function (cu_id) {
        var _this = this;
        var customer$ = this.customerService
    ...
    ListOrderServiceDetailComponent.prototype._patchCustomer = function () {
    ...
    ListOrderServiceDetailComponent.prototype._convertDateToNgbDate = function (date) {
        if (!date) {
            return null;
        }
        var year = moment__WEBPACK_IMPORTED_MODULE_15__(date).year();
        var month = moment__WEBPACK_IMPORTED_MODULE_15__(date).month() + 1;
        var day = moment__WEBPACK_IMPORTED_MODULE_15__(date).date();
        return new _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_4__["NgbDate"](year, month, day);
    };
    ListOrderServiceDetailComponent.prototype._convertNgbDateToDate = function (ngbDate) {
        if (!ngbDate) {
            return '';
        }
    ...
    ListOrderServiceDetailComponent.prototype._notify = function (isSuccess, message) {
    ...
    ListOrderServiceDetailComponent.prototype.isNumber = function (val) {
        return typeof val === 'number';
    };
    ListOrderServiceDetailComponent.ctorParameters = function () { return [
    ...
    return ListOrderServiceDetailComponent;
}());
...
var menu = ['Thông tin khách hàng', 'Thông tin địa chỉ', 'Thông tin dịch vụ', 'Lịch làm việc'];
var days = ['T2', 'T3', 'T4', 'T5', 'T6', 'T7', 'CN'];
...
var OrderServiceDetailComponent = /** @class */ (function () {
    function OrderServiceDetailComponent(formBuilder, customerService, addressService, staffService, serviceService) {
        this.formBuilder = formBuilder;
        this.customerService = customerService;
        this.addressService = addressService;
        this.staffService = staffService;
    ...
    OrderServiceDetailComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        this.formRepeat.valueChanges.subscribe(function (data) { return _this._updateSummary(data); });
    };
    OrderServiceDetailComponent.prototype.onClickMenuItem = function (index) {
        this.selectedMenuItem = index;
        var el = document.getElementById(index);
        var content = document.getElementById('content');
        content.scroll({ top: el.offsetTop - 100, behavior: 'smooth' });
    };
    OrderServiceDetailComponent.prototype.onChangeToMain = function () {
        var _this = this;
    ...
    OrderServiceDetailComponent.prototype.onClickCreateCustomer = function () {
        this.selectedCustomer = {
            cu_id: null,
            cu_code: null,
            cu_fullname: '',
    ...
    OrderServiceDetailComponent.prototype.changeDatalistCustomer = function (e) {
        this.readOnly = true;
        if (!e || e.cu_id === '') {
            this.selectedCustomer = null;
        }
    ...
    OrderServiceDetailComponent.prototype.onChangeProvince = function (e) {
        var districtId = this.provinces.find(function (item) { return item.name === e.target.value; }).id;
        this._loadDistrict(districtId);
    };
    OrderServiceDetailComponent.prototype.onChangeDistrict = function (e) {
        var wardId = this.districts.find(function (item) { return item.name === e.target.value; }).id;
        this._loadWard(wardId);
    };
    OrderServiceDetailComponent.prototype.onRemoveAddress = function (address) {
        this.listAddress = this.listAddress.filter(function (item) { return item.sha_id !== address.sha_id; });
    };
    OrderServiceDetailComponent.prototype.onUpdateAddress = function (address) {
    ...
    OrderServiceDetailComponent.prototype.onClickAddress = function (address) {
        if (this.isView)
            return;
    ...
    OrderServiceDetailComponent.prototype.onClickCreateButton = function () {
        ...
        var newItem = this.listAddress[this.listAddress.length - 1];
        this.selectedAddress =
    ...
    OrderServiceDetailComponent.prototype.changeDatalistService = function (e) {
        this.searchService = { se_name: 'Chọn dịch vụ', se_id: '' };
        if (e.se_id !== '')
            this.listService.push(e);
    };
    OrderServiceDetailComponent.prototype.onRemoveService = function (service) {
        this.listService = this.listService.filter(function (item) { return item.se_id !== service.se_id; });
    };
    OrderServiceDetailComponent.prototype.onClickWeekDay = function (day) {
        if (this.isView)
            return;
        if (day === 'T2')
            this.formRepeat.patchValue({
    ...
    OrderServiceDetailComponent.prototype.checkDay = function (day) {
        if (day === 'T2')
            return this.formRepeat.value.st_mon_flag;
        if (day === 'T3')
            return this.formRepeat.value.st_tue_flag;
    ...
    OrderServiceDetailComponent.prototype.onChangeRepeatType = function (event) {
        if (event.target.value[0] === '2')
            this.onChangeDaySelection('T2');
        if (event.target.value[0] === '1')
            this.onChangeDaySelection('');
    };
    OrderServiceDetailComponent.prototype.onChangeDaySelection = function (event) {
        var day = event.target ? event.target.value : event;
        this.formRepeat.patchValue({
            st_mon_flag: day === 'T2' ? 1 : 0,
            st_tue_flag: day === 'T3' ? 1 : 0,
    ...
    OrderServiceDetailComponent.prototype.onSubmit = function () {
        ...
        var list_service_id = this.listService.map(function (e) {
            return e.se_id;
        });
        var data = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ cuo_id: this.orderService ? this.orderService.cuo_id : null, list_service_id: list_service_id }, repeatData, { cuo_address: this.selectedAddress, customer: tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, customerData, { list_address: this.listAddress }), list_staff_id: this.selectedStaffs, cuo_infor_time: this.summary });
        console.log(data);
        if (this.type === 'update')
    ...
    OrderServiceDetailComponent.prototype.initializeForm = function () {
        this.formCustomer = this.formBuilder.group({
            cu_id: [null, null],
            cu_fullname: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
    ...
    OrderServiceDetailComponent.prototype._patchData = function (data) {
        var customer = data.customer, cuo_address = data.cuo_address, list_service = data.list_service, cuo_infor_time = data.cuo_infor_time, list_staff = data.list_staff;
        this.selectedAddress = cuo_address;
        this.listService = list_service;
        this.selectedCustomer = customer;
        this.summary = cuo_infor_time;
        this.selectedStaffs = list_staff.map(function (e) {
            return e.sta_id;
        });
        this.formRepeat.patchValue({
    ...
    OrderServiceDetailComponent.prototype._fetchCustomer = function (cu_id) {
        var _this = this;
        var customer$ = this.customerService
            .loadCustomerInfo({ cu_id: cu_id })
    ...
    OrderServiceDetailComponent.prototype._patchCustomer = function () {
        var customer = this.selectedCustomer;
    ...
    OrderServiceDetailComponent.prototype._fetchFilter = function () {
        var _this = this;
    ...
    OrderServiceDetailComponent.prototype._loadProvince = function () {
        var _this = this;
    ...
    OrderServiceDetailComponent.prototype._loadDistrict = function (provinceId, isFirst) {
        var _this = this;
        if (isFirst === void 0) { isFirst = false; }
        var district$ = this.addressService
            .loadDistrict({ province_id: provinceId })
    ...
    OrderServiceDetailComponent.prototype._loadWard = function (districtId, isFirst) {
        var _this = this;
        if (isFirst === void 0) { isFirst = false; }
        var ward$ = this.addressService
            .loadWard({ district_id: districtId })
    ...
    OrderServiceDetailComponent.prototype._convertDateToNgbDate = function (date) {
        if (!date) {
            return null;
        }
    ...
    OrderServiceDetailComponent.prototype._convertNgbDateToDate = function (ngbDate) {
        if (!ngbDate) {
            return '';
        }
    ...
    OrderServiceDetailComponent.prototype._createOrderService = function (data) {
        var _this = this;
        var createOrderService$ = this.serviceService
            .createOrderService(data)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.destroyed$));
    ...
    OrderServiceDetailComponent.prototype._updateOrderService = function (updated) {
        var _this = this;
        var updateOrderService$ = this.serviceService
            .updateOrderService(updated)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.destroyed$));
    ...
    OrderServiceDetailComponent.prototype._updateSummary = function (data) {
        data.st_on_the_flag = data.st_on_day_flag === 1 ? 0 : 1;
        var st_repeat_type = data.st_repeat_type, st_sun_flag = data.st_sun_flag, st_mon_flag = data.st_mon_flag, st_tue_flag = data.st_tue_flag, st_wed_flag = data.st_wed_flag, st_thu_flag = data.st_thu_flag, st_fri_flag = data.st_fri_flag, st_sat_flag = data.st_sat_flag, st_repeat_every = data.st_repeat_every, st_on_the = data.st_on_the, st_on_day_flag = data.st_on_day_flag, st_on_day = data.st_on_day, st_on_the_flag = data.st_on_the_flag, st_custom_start = data.st_custom_start, st_custom_end = data.st_custom_end;
        var type = st_repeat_type === 1 ? 'ngày' : st_repeat_type === 2 ? 'tuần' : 'tháng';
        var startCustom = moment__WEBPACK_IMPORTED_MODULE_11__(this._convertNgbDateToDate(st_custom_start)).format('DD/MM');
        var endCustom = st_custom_end
    ...
    OrderServiceDetailComponent.prototype._notify = function (isSuccess, message) {
    ...
    OrderServiceDetailComponent.ctorParameters = function () { return [
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
...
var OrderServiceMainComponent = /** @class */ (function () {
    function OrderServiceMainComponent(serviceService, statisticService, orderService) {
        this.serviceService = serviceService;
    ...
    OrderServiceMainComponent.prototype.ngOnInit = function () {
    ...
    OrderServiceMainComponent.prototype.contentRefresh = function (type) {
        if (type === 'customer')
            this._fetchCustomer();
        else
            this._fetchRate();
    };
    OrderServiceMainComponent.prototype.onChangeToDetail = function (type) {
        this.onDetail.emit({
            type: type,
            data: type === 'create' ? null : this.selectedOrderService,
        });
    };
    OrderServiceMainComponent.prototype.openConfirmModal = function (orderService) {
        var _this = this;
        sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.fire({
            ...
            if (result.value) {
                _this._removeOrder(orderService);
            }
        });
    };
    OrderServiceMainComponent.prototype.onPageChange = function (page) {
        this.page = page;
        this._fetchData();
    };
    OrderServiceMainComponent.prototype.onChangeFilter = function () {
        this._fetchData(this.selectedOrderService);
    };
    OrderServiceMainComponent.prototype._fetchData = function (selected) {
        var _this = this;
        var orderService$ = this.serviceService
            .searchOrderService({
        ...
        orderService$.subscribe(function (res) {
            if (res && res.Data) {
                _this.totalSize = res.Data.TotalNumberOfRecords;
                _this.orderServices = res.Data.Results;
                if (selected) {
                    _this.selectedOrderService = _this.orderServices.find(function (item) { return item.cuo_id === selected.cuo_id; });
                }
                else {
                    _this.selectedOrderService = _this.orderServices[0];
                }
            }
        });
    };
    OrderServiceMainComponent.prototype._fetchCustomer = function () {
        var _this = this;
        var customer$ = this.statisticService.loadCustomer().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["takeUntil"])(this.destroyed$));
        customer$.subscribe(function (res) {
            if (res && res.Data) {
    ...
    OrderServiceMainComponent.prototype._fetchRate = function () {
        var _this = this;
        var rate$ = this.statisticService.loadRate().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["takeUntil"])(this.destroyed$));
    ...
    OrderServiceMainComponent.prototype._notify = function (isSuccess, message) {
    ...
    OrderServiceMainComponent.prototype.onClickOrderService = function (orderService) {
    ...
    OrderServiceMainComponent.prototype._removeOrder = function (order) {
        var _this = this;
    ...
    OrderServiceMainComponent.prototype._convertDateToNgbDate = function (date) {
        if (!date) {
            return null;
        }
    ...
    OrderServiceMainComponent.prototype._convertNgbDateToDate = function (ngbDate) {
        if (!ngbDate) {
            return '';
        }
    ...
    OrderServiceMainComponent.ctorParameters = function () { return [
        { type: _core_services_api_service_service__WEBPACK_IMPORTED_MODULE_9__["ServiceService"] },
    ...
    return OrderServiceMainComponent;
}());
...
var ListOrderServiceComponent = /** @class */ (function () {
    function ListOrderServiceComponent(serviceService, statisticService, router) {
        this.serviceService = serviceService;
        this.statisticService = statisticService;
        this.router = router;
    ...
    ListOrderServiceComponent.prototype.ngOnInit = function () {
    ...
    ListOrderServiceComponent.prototype.ngOnDestroy = function () {
        this.destroyed$.next();
        this.destroyed$.complete();
    };
    ListOrderServiceComponent.prototype.onClickOrderService = function (orderService) {
        if (Object(util__WEBPACK_IMPORTED_MODULE_3__["isNullOrUndefined"])(this.selectedOrderService)) {
            this.selectedOrderService = orderService;
        }
        else {
    ...
    ListOrderServiceComponent.prototype.onRouteDetail = function (orderService) {
        this.router.navigate([
            '/service/list-order-service-detail',
            orderService ? orderService.cuo_id : '',
        ]);
    };
    ListOrderServiceComponent.prototype.contentRefresh = function (type) {
        if (type === 'customer')
            this._fetchCustomer();
        else
            this._fetchRate();
    };
    ListOrderServiceComponent.prototype.openConfirmModal = function (orderService) {
        var _this = this;
    ...
    ListOrderServiceComponent.prototype.onPageChange = function (page) {
        this.page = page;
        this._fetchData();
    };
    ListOrderServiceComponent.prototype.onChangeFilter = function () {
        this._fetchData(this.selectedOrderService);
    };
    ListOrderServiceComponent.prototype.setFile = function (event) {
        var _this = this;
        var files = event.srcElement.files;
        if (!files) {
            return;
        }
        var import$ = this.serviceService
    ...
    ListOrderServiceComponent.prototype.exportOrderService = function () {
        var export$ = this.serviceService
            .exportOrderService({
            pageNumber: this.page - 1,
            pageSize: this.pageSize,
            search_name: this.textSearch,
    ...
    ListOrderServiceComponent.prototype.exportTemplate = function () {
        var export$ = this.serviceService.exportTemplateService().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["takeUntil"])(this.destroyed$));
        export$.subscribe(function (res) {
            if (res && res.Data) {
                var link = 'http://27.72.147.222:1230/' + res.Data;
                window.open(link);
    ...
    ListOrderServiceComponent.prototype._fetchData = function (selected) {
        var _this = this;
        var orderService$ = this.serviceService
            .searchOrderService({
            pageNumber: this.page - 1,
    ...
    ListOrderServiceComponent.prototype._fetchCustomer = function () {
        var _this = this;
        var customer$ = this.statisticService.loadCustomer().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["takeUntil"])(this.destroyed$));
        customer$.subscribe(function (res) {
            if (res && res.Data) {
                _this.customerPieChart.series = [];
                _this.customerPieChart.labels = [];
    ...
    ListOrderServiceComponent.prototype._fetchRate = function () {
        var _this = this;
        var rate$ = this.statisticService.loadRate().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["takeUntil"])(this.destroyed$));
        rate$.subscribe(function (res) {
            if (res && res.Data) {
                _this.ratePieChart.series = [];
                _this.ratePieChart.labels = [];
    ...
    ListOrderServiceComponent.prototype._removeOrder = function (order) {
        var _this = this;
        var removeOrder$ = this.serviceService
    ...
    ListOrderServiceComponent.prototype._notify = function (isSuccess, message) {
    ...
    ListOrderServiceComponent.prototype._convertDateToNgbDate = function (date) {
        if (!date) {
            return null;
        }
    ...
    ListOrderServiceComponent.prototype._convertNgbDateToDate = function (ngbDate) {
        if (!ngbDate) {
            return '';
        }
        if (Object(util__WEBPACK_IMPORTED_MODULE_3__["isUndefined"])(ngbDate.year))
    ...
    ListOrderServiceComponent.ctorParameters = function () { return [
    ...
    return ListOrderServiceComponent;
}());
...
var ListServiceDetailComponent = /** @class */ (function () {
    function ListServiceDetailComponent(route, router, formBuilder, serviceService) {
        this.route = route;
        this.router = router;
        this.formBuilder = formBuilder;
        this.serviceService = serviceService;
    ...
    ListServiceDetailComponent.prototype.ngOnInit = function () {
    ...
    ListServiceDetailComponent.prototype.ngOnDestroy = function () {
        this.destroyed$.next();
        this.destroyed$.complete();
    };
    ListServiceDetailComponent.prototype.onChangeToMain = function () {
        var _this = this;
        if (this.form.dirty) {
            sweetalert2__WEBPACK_IMPORTED_MODULE_7___default.a.fire({
                ...
                if (result.value) {
                    _this.router.navigate(['/service/list-service']);
                }
            });
        }
        else {
    ...
    ListServiceDetailComponent.prototype.onSubmit = function () {
        this.submitted = true;
        ...
        var data = this.form.value;
        if (this.se_id)
            this._updateService(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, data, { se_id: this.se_id }));
        else
            this._createService(data);
    };
    //#region Private
    ListServiceDetailComponent.prototype._initializeForm = function () {
        this.form = this.formBuilder.group({
    ...
    ListServiceDetailComponent.prototype._fetchFilter = function () {
        var _this = this;
        var type$ = this.serviceService.getType().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.destroyed$));
        type$.subscribe(function (res) {
            _this.types = res.Data;
        });
        var category$ = this.serviceService.getCategory().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.destroyed$));
        category$.subscribe(function (res) {
            _this.categories = res.Data;
        });
    };
    ListServiceDetailComponent.prototype._fetchService = function (se_id) {
        var _this = this;
        var info$ = this.serviceService.loadServiceInfo({ se_id: se_id }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.destroyed$));
        info$.subscribe(function (res) {
            if (res && res.Data) {
    ...
    ListServiceDetailComponent.prototype._patchService = function (service) {
        this.form.patchValue({
    ...
    ListServiceDetailComponent.prototype._createService = function (data) {
        var _this = this;
        var createService$ = this.serviceService.createService(data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.destroyed$));
    ...
    ListServiceDetailComponent.prototype._updateService = function (updated) {
        var _this = this;
        var updateService$ = this.serviceService
    ...
    ListServiceDetailComponent.prototype._notify = function (isSuccess, message) {
    ...
    ListServiceDetailComponent.ctorParameters = function () { return [
    ...
    return ListServiceDetailComponent;
}());
...
var ListServiceComponent = /** @class */ (function () {
    function ListServiceComponent(serviceService, router) {
        this.serviceService = serviceService;
        this.router = router;
    ...
    ListServiceComponent.prototype.ngOnDestroy = function () {
        this.destroyed$.next();
        this.destroyed$.complete();
    };
    ListServiceComponent.prototype.onClickService = function (service) {
    ...
    ListServiceComponent.prototype.onRouteDetail = function (service) {
        this.router.navigate(['/service/list-service-detail', service ? service.se_id : '']);
    };
    ListServiceComponent.prototype.openConfirmModal = function (service) {
        var _this = this;
        sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.fire({
            title: 'Chắc chắn muốn xóa dịch vụ đang chọn?',
            type: 'warning',
            ...
            if (result.value) {
                _this._removeService(service);
            }
        });
    };
    ListServiceComponent.prototype.onPageChange = function (page) {
        this.page = page;
        this._fetchData();
    };
    ListServiceComponent.prototype.onChangeFilter = function () {
        this._fetchData(this.selectedService);
    };
    ListServiceComponent.prototype.readURL = function (event) {
    ...
    ListServiceComponent.prototype._fetchData = function (selected) {
        var _this = this;
        var service$ = this.serviceService
            .searchService({
            pageNumber: this.page - 1,
        ...
        service$.subscribe(function (res) {
            if (res && res.Data) {
                ...
                _this.services = res.Data.Results;
                if (selected) {
                    _this.selectedService = _this.services.find(function (item) { return item.se_id === selected.se_id; });
                }
                else {
                    _this.selectedService = _this.services[0];
                }
            }
        });
    };
    ListServiceComponent.prototype._removeService = function (service) {
        var _this = this;
        var removeService$ = this.serviceService
            .removeService({
            serviceId: service.se_id,
        })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(this.destroyed$));
        removeService$.subscribe(function (res) {
            if (res && res.Code === 200) {
                _this._notify(true, res.Message);
                _this._fetchData();
            }
    ...
    ListServiceComponent.prototype._notify = function (isSuccess, message) {
        return sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.fire({
            toast: true,
            position: 'top-end',
            type: isSuccess ? 'success' : 'error',
    ...
    ListServiceComponent.ctorParameters = function () { return [
...
var OrderServiceCalendarComponent = /** @class */ (function () {
    function OrderServiceCalendarComponent(serviceService) {
        this.serviceService = serviceService;
        this.destroyed$ = new rxjs__WEBPACK_IMPORTED_MODULE_7__["Subject"]();
        // calendar plugin
    ...
    OrderServiceCalendarComponent.prototype.ngOnInit = function () {
        this._fetchData();
    };
    OrderServiceCalendarComponent.prototype.onDateClick = function (e) {
        //console.log(e);
    };
    OrderServiceCalendarComponent.prototype.onEventClick = function (e) {
        console.log(e);
        sweetalert2__WEBPACK_IMPORTED_MODULE_10___default.a.fire({
            title: e.event.title,
            type: 'info',
    ...
    OrderServiceCalendarComponent.prototype.onHoverEvent = function () {
        //console.log(event.event._def.title);
    };
    OrderServiceCalendarComponent.prototype.datesRender = function (event) {
        var _a = event.view, activeStart = _a.activeStart, activeEnd = _a.activeEnd;
        this._fetchCalendar(activeStart, activeEnd);
    };
    OrderServiceCalendarComponent.prototype._fetchData = function () {
        this.widgetData = _data__WEBPACK_IMPORTED_MODULE_6__["widgetData"];
    };
    OrderServiceCalendarComponent.prototype._fetchCalendar = function (start, end) {
        var _this = this;
        var calendar$ = this.serviceService
            .getCalendar({
        ...
        calendar$.subscribe(function (res) {
            _this.calendarEvents = [];
            res.Data.forEach(function (day) {
                var work_time = day.work_time, list_service = day.list_service;
                var work_day = work_time.substr(0, 11);
                list_service.forEach(function (time) {
                    var start_time = time.start_time, end_time = time.end_time, service_name = time.service_name;
    ...
    OrderServiceCalendarComponent.ctorParameters = function () { return [
    ...
    return OrderServiceCalendarComponent;
}());
...
var ReceiveWorkComponent = /** @class */ (function () {
    function ReceiveWorkComponent(modalService, transactionService, statisticService) {
        this.modalService = modalService;
    ...
    ReceiveWorkComponent.prototype.ngOnInit = function () {
        this._fetchData();
        this._fetchCustomer();
        this._fetchRate();
    ...
    ReceiveWorkComponent.prototype.onClickOrder = function (transaction) {
    ...
    ReceiveWorkComponent.prototype.openCustomerCareModal = function () {
    ...
    ReceiveWorkComponent.prototype.openConfirmModal = function (transaction) {
        var _this = this;
        sweetalert2__WEBPACK_IMPORTED_MODULE_7___default.a.fire({
    ...
    ReceiveWorkComponent.prototype.onPageChange = function (page) {
        this.page = page;
        this._fetchData();
    };
    ReceiveWorkComponent.prototype.onChangeFilter = function () {
        this._fetchData(this.selectedOrder);
    };
    ReceiveWorkComponent.prototype.exportTransaction = function () {
    ...
    ReceiveWorkComponent.prototype._fetchData = function (selected) {
        var _this = this;
    ...
    ReceiveWorkComponent.prototype._fetchCustomer = function () {
        var _this = this;
    ...
    ReceiveWorkComponent.prototype._fetchRate = function () {
        var _this = this;
    ...
    ReceiveWorkComponent.prototype._removeTransaction = function (transaction) {
        var _this = this;
    ...
    ReceiveWorkComponent.prototype._notify = function (isSuccess, message) {
        return sweetalert2__WEBPACK_IMPORTED_MODULE_7___default.a.fire({
            toast: true,
            position: 'top-end',
            type: isSuccess ? 'success' : 'error',
    ...
    ReceiveWorkComponent.prototype._convertDateToNgbDate = function (date) {
        if (!date) {
            return null;
        }
    ...
    ReceiveWorkComponent.prototype._convertNgbDateToDate = function (ngbDate) {
        if (!ngbDate) {
            return '';
        }
    ...
    ReceiveWorkComponent.ctorParameters = function () { return [
