...
var ListServiceCategoryModalComponent = /** @class */ (function () {
    function ListServiceCategoryModalComponent(modalService) {
        this.modalService = modalService;
        this.passEvent = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    ListServiceCategoryModalComponent.prototype.ngOnInit = function () {
        this.loadServiceCategoryData();
    };
    ListServiceCategoryModalComponent.prototype.onClickCancel = function () {
        this.passEvent.emit({ event: false });
    };
    ListServiceCategoryModalComponent.prototype.onClickChoose = function () {
        this.passEvent.emit({ event: false });
    };
    ListServiceCategoryModalComponent.prototype.onClickServiceCategory = function (serviceCategory) {
    ...
    ListServiceCategoryModalComponent.prototype.openServiceCategoryModal = function () {
        var _this = this;
        var modalRef = this.modalService.open(_service_category_modal_service_category_modal_component__WEBPACK_IMPORTED_MODULE_4__["ServiceCategoryModalComponent"], {
            centered: true
        });
        ...
        modalRef.componentInstance.passEvent.subscribe(function (res) {
            if (res.event) {
                if (_this.selectedServiceCategory) {
                    _this.updateServiceCategory(_this.selectedServiceCategory, res.form);
                }
                else {
                    _this.createServiceCategory(res.form);
                }
            }
            modalRef.close();
        });
    };
    ListServiceCategoryModalComponent.prototype.openConfirmModal = function () {
        var _this = this;
        ...
        modalRef.componentInstance.passEvent.subscribe(function (res) {
            if (res) {
                _this.removeServiceCategory(_this.selectedServiceCategory);
            }
            modalRef.close();
        });
    };
    ListServiceCategoryModalComponent.prototype.loadServiceCategoryData = function () {
        this.serviceCategories = _data__WEBPACK_IMPORTED_MODULE_3__["serviceCategoryData"];
    };
    ListServiceCategoryModalComponent.prototype.createServiceCategory = function (data) { };
    ListServiceCategoryModalComponent.prototype.updateServiceCategory = function (serviceCategoryId, data) { };
    ListServiceCategoryModalComponent.prototype.removeServiceCategory = function (serviceCategory) { };
    ListServiceCategoryModalComponent.ctorParameters = function () { return [
    ...
    return ListServiceCategoryModalComponent;
}());
...
var ServiceCategoryModalComponent = /** @class */ (function () {
    function ServiceCategoryModalComponent(formBuilder, modalService) {
    ...
    ServiceCategoryModalComponent.prototype.ngOnInit = function () {
        if (this.serviceCategory) {
            this.patchData(this.serviceCategory);
        }
    };
    ServiceCategoryModalComponent.prototype.onClickSubmit = function () {
        this.submitted = true;
        if (this.form.valid) {
            this.passEvent.emit({ event: true, form: this.form.value });
        }
    };
    ServiceCategoryModalComponent.prototype.onClickCancel = function () {
        var _this = this;
        if (this.form.dirty) {
    ...
    Object.defineProperty(ServiceCategoryModalComponent.prototype, "formUI", {
        get: function () {
    ...
    ServiceCategoryModalComponent.prototype.initializeForm = function () {
    ...
    ServiceCategoryModalComponent.prototype.patchData = function (serviceCategory) {
    ...
    ServiceCategoryModalComponent.ctorParameters = function () { return [
    ...
    return ServiceCategoryModalComponent;
}());
...
var ServiceModalComponent = /** @class */ (function () {
    function ServiceModalComponent(formBuilder, modalService) {
        this.formBuilder = formBuilder;
        this.modalService = modalService;
        this.passEvent = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.submitted = false;
    ...
    ServiceModalComponent.prototype.ngOnInit = function () {
        if (this.service) {
            this.patchData(this.service);
        }
    };
    ServiceModalComponent.prototype.openServiceCategoryModal = function () {
        var modalRef = this.modalService.open(_list_service_category_modal_list_service_category_modal_component__WEBPACK_IMPORTED_MODULE_5__["ListServiceCategoryModalComponent"], {
            centered: true,
            size: 'lg'
        });
        modalRef.componentInstance.passEvent.subscribe(function (res) {
    ...
    ServiceModalComponent.prototype.onClickSubmit = function () {
        this.submitted = true;
        if (this.form.valid) {
            this.passEvent.emit({ event: true, form: this.form.value });
        }
    };
    ServiceModalComponent.prototype.onClickCancel = function () {
        var _this = this;
        if (this.form.dirty) {
            var modalRef_1 = this.modalService.open(_confirm_modal_confirm_modal_component__WEBPACK_IMPORTED_MODULE_4__["ConfirmModalComponent"], {
                centered: true
    ...
    Object.defineProperty(ServiceModalComponent.prototype, "formUI", {
        get: function () {
            return this.form.controls;
        },
        enumerable: true,
    ...
    ServiceModalComponent.prototype.initializeForm = function () {
        this.form = this.formBuilder.group({
    ...
    ServiceModalComponent.prototype.patchData = function (service) {
        this.form.patchValue({
    ...
    ServiceModalComponent.ctorParameters = function () { return [
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["NgbModal"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
var ListServiceComponent = /** @class */ (function () {
    function ListServiceComponent(modalService, formBuilder) {
        this.modalService = modalService;
        this.formBuilder = formBuilder;
        this.page = 1;
        this.pageSize = 10;
    ...
    ListServiceComponent.prototype.openServiceModal = function (service) {
        var _this = this;
        var modalRef = this.modalService.open(_component_service_modal_service_modal_component__WEBPACK_IMPORTED_MODULE_6__["ServiceModalComponent"], {
            centered: true,
            size: 'lg'
        });
        if (service) {
        ...
        modalRef.componentInstance.passEvent.subscribe(function (res) {
            if (res.event) {
                if (service) {
                    _this.updateService(service, res.form);
                }
                else {
                    _this.createService(res.form);
                }
            }
            modalRef.close();
        });
    ...
    ListServiceComponent.prototype.openConfirmModal = function (service) {
        var _this = this;
        var modalRef = this.modalService.open(_component_confirm_modal_confirm_modal_component__WEBPACK_IMPORTED_MODULE_5__["ConfirmModalComponent"], {
            centered: true
        });
        this.onClickService(service);
    ...
    ListServiceComponent.prototype._fetchData = function () {
    ...
    ListServiceComponent.prototype.createService = function (data) {
        this.submitted = true;
        this.totalSize = this.services.length + 1;
        this.paginatedServiceData = this.services.slice(this.startIndex, this.endIndex);
    };
    ListServiceComponent.prototype.updateService = function (service, data) { };
    ListServiceComponent.prototype.removeService = function (service) { };
...
var OrderServiceModalComponent = /** @class */ (function () {
    function OrderServiceModalComponent(formBuilder, modalService) {
        this.formBuilder = formBuilder;
        this.modalService = modalService;
        this.passEvent = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    OrderServiceModalComponent.prototype.ngOnInit = function () {
        this.selectionTime = _data__WEBPACK_IMPORTED_MODULE_5__["selectionTime"];
    };
    Object.defineProperty(OrderServiceModalComponent.prototype, "formUI", {
        get: function () {
            return this.form.controls;
        },
        enumerable: true,
    ...
    OrderServiceModalComponent.prototype.onClickSubmit = function () {
        this.passEvent.emit({ event: true });
    };
    OrderServiceModalComponent.prototype.onClickCancel = function () {
        var _this = this;
    ...
    OrderServiceModalComponent.ctorParameters = function () { return [
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["NgbModal"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    return OrderServiceModalComponent;
}());
...
var OrderServiceComponent = /** @class */ (function () {
    function OrderServiceComponent(modalService, formBuilder) {
        this.modalService = modalService;
        this.formBuilder = formBuilder;
        // calendar plugin
    ...
    OrderServiceComponent.prototype.openOrderServiceModal = function (event) {
        var modalRef = this.modalService.open(_component_order_service_modal_order_service_modal_component__WEBPACK_IMPORTED_MODULE_9__["OrderServiceModalComponent"], {
            centered: true,
            size: 'lg'
        });
        modalRef.componentInstance.passEvent.subscribe(function (res) {
    ...
    OrderServiceComponent.prototype.onHoverEvent = function (event) {
        console.log(event.event._def.title);
    };
    Object.defineProperty(OrderServiceComponent.prototype, "form", {
        /**
         * Returns form
         */
        get: function () {
    ...
    OrderServiceComponent.prototype.onChangeRepeatCheckbox = function (e) {
        if (e.target.checked) {
            this.repeat = 'day';
        }
        else {
    ...
    OrderServiceComponent.prototype.onChangeRepeatSelect = function (e) {
        this.repeat = e.target.value;
    };
    /**
     * Upldated event title save in calendar
     */
    OrderServiceComponent.prototype.editEventSave = function () {
        var _this = this;
        var editTitle = this.formEditData.get('editTitle').value;
        var editId = this.calendarEvents.findIndex(function (x) { return x.id + '' === _this.editEvent.id + ''; });
        // tslint:disable-next-line: radix
        this.calendarEvents[editId] = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, this.editEvent, { title: editTitle, 
            // tslint:disable-next-line:radix
     ...
     */
    OrderServiceComponent.prototype.deleteEventData = function () {
        var deleteId = this.editEvent.id;
        var deleteEvent = this.calendarEvents.findIndex(function (x) { return x.id + '' === deleteId + ''; });
        this.calendarEvents[deleteEvent] = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, this.deleteEvent, { id: '' });
     ...
     */
    OrderServiceComponent.prototype.saveEvent = function () {
        if (this.formData.valid) {
            var title = this.formData.get('title').value;
            // tslint:disable-next-line: no-shadowed-variable
            var category_1 = this.formData.get('category').value;
     ...
     */
    OrderServiceComponent.prototype._fetchData = function () {
    ...
    OrderServiceComponent.ctorParameters = function () { return [
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["NgbModal"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] }
    ]; };
