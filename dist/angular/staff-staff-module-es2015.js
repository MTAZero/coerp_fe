...
let AssignWorkComponent = class AssignWorkComponent {
    constructor(staffService, customerService, router) {
    ...
    _fetchFilter() {
        ...
        const customerGroup$ = this.customerService.loadGroup().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(this.destroyed$));
        ...
        const customerType$ = this.customerService.loadType().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(this.destroyed$));
        customerType$.subscribe((res) => {
