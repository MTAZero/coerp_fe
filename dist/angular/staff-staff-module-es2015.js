...
let AddressTabComponent = class AddressTabComponent {
    constructor(modalService, staffService) {
...
let DepartmentModalComponent = class DepartmentModalComponent {
...
DepartmentModalComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
...
let ListDepartmentModalComponent = class ListDepartmentModalComponent {
    ...
    openDepartmentModal() {
        const modalRef = this.modalService.open(_department_modal_department_modal_component__WEBPACK_IMPORTED_MODULE_3__["DepartmentModalComponent"], {
            centered: true
        });
...
ListDepartmentModalComponent.ctorParameters = () => [
    { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbModal"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])(),
...
let ListPositionModalComponent = class ListPositionModalComponent {
    constructor(modalService) {
        this.modalService = modalService;
        this.passEvent = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    ...
    openPositionModal() {
        const modalRef = this.modalService.open(_position_modal_position_modal_component__WEBPACK_IMPORTED_MODULE_3__["PositionModalComponent"], {
            centered: true
        });
...
ListPositionModalComponent.ctorParameters = () => [
    { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbModal"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])(),
...
let PositionModalComponent = class PositionModalComponent {
...
PositionModalComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
...
let StaffModalComponent = class StaffModalComponent {
    constructor(formBuilder, modalService, departmentService, positionService, staffService) {
        this.formBuilder = formBuilder;
        this.modalService = modalService;
    ...
    openPositionModal() {
        const modalRef = this.modalService.open(_list_position_modal_list_position_modal_component__WEBPACK_IMPORTED_MODULE_4__["ListPositionModalComponent"], {
            centered: true,
            size: 'lg'
        });
    ...
    openDepartmentModal() {
        const modalRef = this.modalService.open(_list_department_modal_list_department_modal_component__WEBPACK_IMPORTED_MODULE_5__["ListDepartmentModalComponent"], {
            centered: true
        });
        modalRef.componentInstance.passEvent.subscribe(() => {
            modalRef.close();
    ...
    _fetchData() {
        const positions$ = this.positionService.loadAllPosition().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["takeUntil"])(this.destroyed$));
        positions$.subscribe((res) => {
            if (res && res.Data) {
                this.positions = res.Data;
            }
        });
        const department$ = this.departmentService.loadAllDepartment().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["takeUntil"])(this.destroyed$));
        department$.subscribe((res) => {
            if (res && res.Data) {
                this.departments = res.Data;
            }
        });
        const role$ = this.staffService.loadGroupRole().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["takeUntil"])(this.destroyed$));
        role$.subscribe((res) => {
            if (res && res.Data) {
                this.roles = res.Data;
            }
...
StaffModalComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["NgbModal"] },
...
let ListStaffComponent = class ListStaffComponent {
    ...
    openStaffModal(staff) {
        const modalRef = this.modalService.open(_component_staff_modal_staff_modal_component__WEBPACK_IMPORTED_MODULE_3__["StaffModalComponent"], {
            centered: true,
            size: 'lg'
        });
        if (staff) {
    ...
    _createStaff(data) {
        const createStaff$ = this.staffService.createStaff(data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.destroyed$));
