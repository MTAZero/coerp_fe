...
@Component({
  ...
  templateUrl: './list-transaction-service.component.html',
  styleUrls: ['./list-transaction-service.component.scss'],
})
export class ListTransactionServiceComponent implements OnInit, OnDestroy {
