...
@Component({
  ...
  templateUrl: './list-transaction-product-detail.component.html',
  styleUrls: ['./list-transaction-product-detail.component.scss'],
})
export class ListTransactionProductDetailComponent implements OnInit, OnDestroy {
  tra_id = null;
