...
@Component({
  ...
  templateUrl: './relative-tab.component.html',
  styleUrls: ['./relative-tab.component.scss'],
})
export class RelativeTabComponent implements OnInit {
  ...
  ngOnChanges() {
    ...
    if (this.selectedRelative)
      this.selectedRelative = this.listRelative.filter(
